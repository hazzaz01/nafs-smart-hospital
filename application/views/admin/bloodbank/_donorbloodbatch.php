...
<div class="table-responsive">
        ...
        <table class="table table-striped table-bordered table-hover example" id="testreport">
            <thead>
                <tr class="table-heading-sticky">
                    ...
                    <th class="text-right pe--10"><?php echo $this->lang->line('net_amount'); ?>  (<?php echo $currency_symbol; ?>)</th>
    ...
    $discount_amt=calculatePercent( $detail->apply_charge,$detail->discount_percentage);
                        ...
                        <td class="text-right pe--10"><?php $netamount =    $detail->standard_charge + calculatePercent(($detail->apply_charge-$discount_amt),$detail->tax_percentage) ; echo amountFormat($netamount); ?></td>
