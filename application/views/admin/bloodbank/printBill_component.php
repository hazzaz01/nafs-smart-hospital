                        ...
                        <div class="col-md-12">
                            <table class="print-table mb-0">
                             ...
                             <tbody>
                                <tr>
                                   <td>1</td>
                                   <td><?php echo $result['charge_categorie_name'];?><br></td>
                                ...
                                <tr>
                                   ...
                                   <td class="text-right no-line">
                                    <?php echo $currency_symbol . "" . amountFormat($result['paid_amount']); ?>
                                    </td>
                                </tr>
                                  <tr>
                                   <td colspan="2" class="no-line"></td>
                                   ...
                                   <td class="text-right no-line">
                                    <?php echo $currency_symbol . "" . amountFormat(($result['amount']-$discont_amt)+$tax_amt-$result['paid_amount']); ?>
