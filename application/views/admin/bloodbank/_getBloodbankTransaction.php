            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <table class="table table-hover table-sm">
                    ...
                    <tr>     
                        ...
                        <td class="text text-right"> <?php echo $currency_symbol.calculatePercent($blood_issue_detail['amount'],$blood_issue_detail['discount_percentage'])." (".$blood_issue_detail['discount_percentage']."%) "?></td>
                    </tr>
                    <tr>
                    ...
                    <td class="text text-right"><?php echo $currency_symbol.calculatePercent($total_tax_amount,$blood_issue_detail['tax_percentage'])." (".$blood_issue_detail['tax_percentage']."%)"?>
                        </td>
                    </tr> 
                    <tr>                   
