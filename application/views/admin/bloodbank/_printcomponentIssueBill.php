...
<div class="fixed-print-header">
    <?php if (!empty($print_details[0]['print_header'])) { ?>
        <div>
            <img src="<?php if (!empty($print_details[0]['print_header'])) { echo $this->media_storage->getImageURL($print_details[0]['print_header']);  } ?>" class="img-responsive" style="height:100px; width: 100%;">
        </div>
        <?php } ?>
</div>   
                        ...
                        <div class="col-md-6"> 
							<table class="noborder_table">
								...
								<tr>
                                    ...
                                    <td width="35%" ><?php echo $this->customlib->bag_string($blood_issues_detail['bag_no'],$blood_issues_detail['volume'],$blood_issues_detail['unit_name']); ?></td>
                                </tr>
							</table>                   
                        </div>
                            ...
                            <table class="print-table">
                             ...
                             <tbody>
                                <tr>
                                   ...
                                   <td><?php echo $blood_issues_detail['charge_categorie_name'];?><br>
                                    ...
                                    <td class="text-center">                                       
										<?php echo $tax_amt;?> (<?php echo $blood_issues_detail['tax_percentage']; ?>%)<br>
                                    </td>                                 
                                ...
                                <tr>
                                   ...
                                   <td class="text-right no-line"><?php echo $currency_symbol . "" . $discont_amt; ?> (<?php echo $blood_issues_detail['discount_percentage']; ?>%)</td>
                                </tr>
                                <tr>
                                   <td colspan="2" class="no-line"></td>
                                   <td class="text-right no-line"><?php echo $this->lang->line('tax'); ?></td>
                                   <td class="text-right no-line"><?php echo $currency_symbol . "" . $tax_amt; ?> (<?php echo $blood_issues_detail['tax_percentage']; ?>%)</td>
                                </tr>
                                <tr>
                                   <td colspan="2" class="no-line"></td>
