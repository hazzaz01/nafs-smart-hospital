                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                                        ...
                                                        <div id="input-type" class="row">
                                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                                <label class="radio-inline">
                                                                    <input checked="checked" name="charge_type" class="finetype" onclick="get_payment_type('paypal_charge_value',this.value)" id="charge_type" value="none" type="radio" <?php if(isset($paypal_result->charge_type) && $paypal_result->charge_type=='none'){ ?> checked="checked" readonly <?php } ?>><?php echo $this->lang->line('none'); ?>
                                                                </label>
                                                            </div>
                                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                                <label class="radio-inline">
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://www.paypal.com/in/home" target="_blank"><img src="<?php echo $this->media_storage->getImageURL('backend/images/paypal.png') ?>" width="200"><p>https://www.paypal.com</p></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box-body minheight149">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://stripe.com/" target="_blank"><img src="<?php echo $this->media_storage->getImageURL('backend/images/stripe.png')?>"><p>https://stripe.com</p></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box-body minheight149">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://www.payumoney.com" target="_blank"><img src="<?php echo $this->media_storage->getImageURL('backend/images/paym.png')?>"><p>https://www.payumoney.com</p></a>
                                ...
                                <div class="box-body minheight149">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://www.instamojo.com/" target="_blank"><img src="<?php echo $this->media_storage->getImageURL('backend/images/instamojo.png')?>" width="200"><p>https://www.instamojo.com/</p></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://paystack.com/" target="_blank"><img src="<?php echo $this->media_storage->getImageURL('/backend/images/paystack.png');?>" width="200"><p>https://paystack.com</p></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-7">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                    <label class="control-label col-md-5 col-sm-5 col-xs-12" for="exampleInputEmail1">
                                                       <?php echo $this->lang->line('razorpay_secret_key'); ?><small class="req"> *</small>
                                                    </label>
                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://razorpay.com/" target="_blank"><img src="<?php echo $this->media_storage->getImageURL('/backend/images/razorpay.jpg');?>" width="200"><p>https://razorpay.com/</p></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://paytm.com/" target="_blank"><img src="<?php echo $this->media_storage->getImageURL('/backend/images/paytm.jpg');?>" width="200"><p>https://paytm.com/</p></a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://midtrans.com/" target="_blank"><img src="<?php echo $this->media_storage->getImageURL('/backend/images/midtrans.jpg');?>" width="200"><p>https://midtrans.com/</p></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box-body">
                                    <div class="row"> 
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://www.pesapal.com/" target="_blank"><img src="<?php echo $this->media_storage->getImageURL('/backend/images/pesapal.jpg');?>" width="200"><p>https://www.pesapal.com/</p></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://ipayafrica.com/" target="_blank"><img src="<?php echo $this->media_storage->getImageURL('/backend/images/ipayafrica.png');?>" width="200"><p>https://ipayafrica.com//</p></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://www.billplz.com/" target="_blank">
                                                    ...
                                                    <img src="<?php echo $this->media_storage->getImageURL('/backend/images/billplz.jpg');?>" width="200"><p>https://www.billplz.com/</p></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://www.jazzcash.com.pk/" target="_blank">
                                                    ...
                                                    <img src="<?php echo $this->media_storage->getImageURL('/backend/images/jazzcash.jpg');?>" width="200"><p>https://www.jazzcash.com.pk/</p></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://flutterwave.com/us/" target="_blank">
                                                    ...
                                                    <img src="<?php echo $this->media_storage->getImageURL('/backend/images/flutterwave.png')?>" width="200"><p>https://flutterwave.com/us</p></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://www.sslcommerz.com/" target="_blank">
                                                    ...
                                                    <img src="<?php echo $this->media_storage->getImageURL('/backend/images/sslcommerz.png');?>" width="200"><p>https://www.sslcommerz.com/</p></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://walkingm.com/" target="_blank">
                                                    ...
                                                    <img src="<?php echo $this->media_storage->getImageURL('/backend/images/walkingm.png');?>" width="200"><br><br><p>https://walkingm.com/</p></a>
                                            </div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://www.mollie.com/" target="_blank">
                                                    ...
                                                    <img src="<?php echo $this->media_storage->getImageURL('/backend/images/mollie.png'); ?>" width="200"><br><br><p>https://www.mollie.com/</p></a>
                                            </div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://www.cashfree.com/" target="_blank">
                                                    ...
                                                    <img src="<?php echo $this->media_storage->getImageURL('/backend/images/cashfree.png'); ?>" width="200"><br><br><p>https://www.cashfree.com/</p></a>
                                            </div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://www.payfast.co.za/" target="_blank">
                                                    ...
                                                    <img src="<?php echo $this->media_storage->getImageURL('/backend/images/payfast.png'); ?>" width="200"><br><br><p>https://www.payfast.co.za/</p></a>
                                            </div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
                                    ...
                                    <div class="row"> 
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://toyyibpay.com/" target="_blank">
                                                    ...
                                                    <img src="<?php echo $this->media_storage->getImageURL('/backend/images/toyyibpay.png'); ?>" width="200"><br><br><p>https://toyyibpay.com/</p></a>
                                            </div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
                                    ...
                                    <div class="row"> 
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://www.2checkout.com/" target="_blank">
                                                     <h5><?php echo $this->lang->line('payment_gateway_for_malaysia');?></h5><br>
                                                    <img src="<?php echo $this->media_storage->getImageURL('/backend/images/twocheckout.png'); ?>" width="200"><br><br><p>https://www.2checkout.com/</p></a>
                                            </div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
                                    ...
                                    <div class="row"> 
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://www.skrill.com/" target="_blank">
                                                     <h5><?php echo $this->lang->line('payment_gateway_for_malaysia');?></h5>
                                                     <br>
                                                    <img src="<?php echo $this->media_storage->getImageURL('/backend/images/skrill.jpg'); ?>" width="200">
                                                    <br>
                                                    <br>
...
?>
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://www.payhere.lk/" target="_blank">
                                                     ...
                                                     <br>
                                                    <img src="<?php echo $this->media_storage->getImageURL('/backend/images/payhere.png'); ?>" width="200">
                                                    <br>
                                                    <br>
...
?>
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://www.onepay.vn/" target="_blank">
                                                    ...
                                                    <img src="<?php echo $this->media_storage->getImageURL('/backend/images/onepay.svg');?>" width="200"><br><br><p>https://www.onepay.vn</p></a>
                                            </div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
