                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover ajaxlist" id="testreport" cellspacing="0" width="100%" data-export-title="<?php echo $this->lang->line('pathology_test_reports'); ?>">
                            ...
                            <tr>
                                ...
                                ?> 
                                <th class="text-right white-space-nowrap"><?php echo $this->lang->line('amount') . ' (' . $currency_symbol . ')'; ?></th>
                                <th class="text-right white-space-nowrap"><?php echo $this->lang->line('discount'); ?></th>
                                <th class="text-right white-space-nowrap"><?php echo $this->lang->line('tax'). ' (' . $currency_symbol . ')';; ?></th>
