                ...
                <tr>                   
                    ...
                    <td class="text-right">
                        <?php if (!empty($pathology_billing->discount)) {
                            echo $currency_symbol.$pathology_billing->discount." (".$pathology_billing->discount_percentage."%) ";
                       }  ?>                           
                    </td>
                </tr>                
                 <tr>
                    ...
                    <td class="text-right">    
                        ...
                        $tax_percentage = amountFormat(($pathology_billing->tax*100)/($pathology_billing->total-$pathology_billing->discount));
                        
                        if (!empty($pathology_billing->tax)) {
                            echo $currency_symbol.$pathology_billing->tax.' ('.$tax_percentage.'%)' ;
                        }  ?> 
                    </td>    
                </tr>    
                 <tr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        if (!empty($pathology_billing->total_deposit)) {
                                            echo amountFormat($pathology_billing->net_amount-$pathology_billing->total_deposit) ;
                                        }
