	...
	<div class="table-responsive">
          ...
          <div class="col-md-2">
            <table class="table table-hover table-sm">
              ...
              <tr>
                ...
                <td><?php echo $this->customlib->get_patient_current_age($result->patient_id);
                 ?> </td>          
              </tr>
              <tr>
        ...
        <div class="col-md-3">
          ...
          <tr>         
            ...
            $tax_percentage = amountFormat(($result->tax*100)/($result->total-$result->discount));
            
            if (!empty($result->tax)) {
              echo $currency_symbol.$result->tax.' ('.$tax_percentage.'%)' ;
            }  ?></td>
          </tr>        
          <tr>   
          ...
          <tr>    
            ...
            <td class="col-lg-3 text text-right">
        ...
        <table class="table table-hover table-sm">
                             <thead>
                                <tr class="line">
                                   ...
                                   <td><?php echo $this->lang->line('report_date'); ?></td>
                        ...
                        foreach ($result->pathology_report as $report_key=> $report_value) {   
                            ...
                            <tr>
                                ...
                                <td><?php echo $report_value->test_name; ?>
                                 ...
                                 <td>
                                 	<?php                                 	
                                 	echo  $this->customlib->YYYYMMDDTodateFormat($report_value->reporting_date); ?></td>
                                  <td class="text-left"><?php if($report_value->approved_by_staff_employee_id!=''){ ?>
                                 	<?php      
                                ...
                                <td class="text-right"><?php echo $currency_symbol.$taxamount." (".$report_value->tax_percentage."%)"; ?></td>
                                 <td class="text-right"><?php echo $currency_symbol.number_format((float)($report_value->apply_charge - $discount_amt + $taxamount), 2, '.', '');  ?></td>
                               <td class="text-right">
                                <?php 
