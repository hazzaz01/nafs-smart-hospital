                                    ...
                                    <div class="">
                                        <div class="col-md-7">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="file" class="filestyle form-control-file" name="logo" id="exampleInputFile" data-height="100" data-default-file="<?php echo $this->customlib->getBaseUrl().$frontcmslist->logo; ?>">
