...
?>
                                            <div class="childimg">
                                                <img src="<?php echo $this->media_storage->getImageURL($file) ?>" id="image" alt="User profile picture">
                                            </div>
...
$file = "uploads/patient_images/no_image.png";
?>
                                            <div class="childimg"><img src="<?php echo $this->media_storage->getImageURL($file) ?>" id="imagem" alt="User profile picture"></div>
...
$file = "uploads/patient_images/no_image.png";
?>
                                            <div class="childimg"><img class="" src="<?php echo $this->media_storage->getImageURL($file) ?>" id="imagef" alt="User profile picture"></div>
                                    ...
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('birth_date'); ?></th>
                                        <td><span id="vbirth_date"></span></td>
                                    </tr>
                                    <tr>
    ...
    function viewDetail(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#image").attr("src", data.child_pic);
                $("#imagem").attr("src", data.mother_pic);
                $("#imagef").attr("src",data.father_pic);
                ...
                if (data.document) {
                    $('#download_document').html("<a href='<?php echo base_url(); ?>admin/birthordeath/download/" + id + "' data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('download'); ?>'><i class='fa fa-download'></i></a>");
                }
            },
        });
    }
