                            ...
                            <td>
                                <table cellspacing="0" cellpadding="0" width="100%" class="noborder_table"  class="mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top" width="25%"><?php echo (isset($result["gender"])) ? $this->lang->line(strtolower($result["gender"])) : ""; ?></td>
...
if ($result['child_pic'] !== $picdemo) {
    ?>
                                    <img  style="height: 60px;" class="" src="<?php echo $this->media_storage->getImageURL($result['child_pic']) ?>" id="image" alt="User profile picture">
                                <?php }?>
                            </td>
                        </tr>
                    </table>
