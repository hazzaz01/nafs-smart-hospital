        ...
        <tr>
            <td style="position: absolute;left:0;">
                <?php if ($certificate->enable_patient_image == 1) { ?>
                    <img style="position: relative; <?php echo "top:" . $certificate->enable_image_height . "px" ?>;" src="<?php echo $this->media_storage->getImageURL('uploads/patient_images/no_image.png') ?>" width="100" height="auto">
                <?php } ?>
            </td></tr>
        <tr>
