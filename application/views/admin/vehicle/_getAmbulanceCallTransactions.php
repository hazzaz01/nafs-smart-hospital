            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                <table class="table table-hover table-sm">
                    ...
                    <tr>
                        ...
                        <td><?php echo $ambullance_call_detail['driver_contact']?></td>
                    </tr>    
                    <tr>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <table class="table table-hover table-sm">
                    ...
                    <tr>
						...
						echo $currency_symbol.$dicount_amount; ?> (<?php echo $ambullance_call_detail['discount_percentage'] ?>%)
                        </td>
                    </tr> 
                    <tr>
						...
						echo $currency_symbol.calculatePercent($final_amount,$ambullance_call_detail['tax_percentage'])?> (<?php echo $ambullance_call_detail['tax_percentage'] ?>%)
                        </td>
                    </tr>                     
                    <tr>                   
    ...
    <hr>
        ...
        <?php
             ...
             ?>
                    ...
                    <?php }}else{
                        ?>
                        <tr><td colspan="6" class="text-center text-danger"><?php echo $this->lang->line('no_record_found')?></td></tr>
                        <?php
                    } ?>
                </tbody>
            </table>
