                    ...
                    <table class="printablea4" style="width: 40%; float: right; padding-bottom:10px;">
                        <?php if (!empty($result["amount"])) { ?>
                            <tr>
                                ...
                                <td width="40%" class="text-right rtl-text-left"><?php echo amountFormat($result["amount"]); ?></td>
                            </tr>
                        <?php } ?>
                        <?php if (!empty($result["discount"])) { ?>                        
                                <tr>
                                    <th width="60%" class="text-right rtl-text-left"><?php
                                        ...
                                        ?></th>
                                    <td width="40%" class="text-right rtl-text-left"><?php echo amountFormat($result["discount"]). " (" .$result["discount_percentage"] . "%)"  ; ?></td>
                                </tr>                                
                        <?php } ?>        
                        <?php if (!empty($result["tax_percentage"])) { ?>
                            <tr>
                                <th width="60%" class="text-right rtl-text-left"><?php
									...
									?></th>
                                <td width="40%" class="text-right rtl-text-left"><?php echo calculatePercent($final_amount, $result["tax_percentage"]) . " (".$result["tax_percentage"]."%)"; ?></td>
                            </tr>
                        <?php } ?>                        
                        <?php
                        if (!empty($result["net_amount"])) {                       
                                ...
                                <tr>
                                    ...
                                    <td width="40%" class="text-right rtl-text-left"><?php echo amountFormat($result["net_amount"]); ?></td>
                                </tr>
                                <?php    
                        }
                        ?> 
                        ...
                        if (!empty($result["total_paid"])) {
                                ...
                                <tr>
                                    ...
                                    <td width="40%" class="text-right rtl-text-left"><?php echo amountFormat($result["total_paid"]); ?></td>
                                </tr>
                                <?php
                        }
                        ?> 
                                <tr>
                                    ...
                                    <td width="40%" class="text-right rtl-text-left"><?php echo amountFormat($result["net_amount"]-$result["total_paid"]); ?></td>
                                </tr>                     
                    </table>
