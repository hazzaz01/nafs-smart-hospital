                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">    
                                        ...
                                        <table class="table tableover table-striped mb0 table-bordered table-hover tablefull12 tblProducts" id="tableID">
                                            <thead>
                                                <tr class="font13 white-space-nowrap">
                                                    ...
                                                    <th width="12%"><?php echo $this->lang->line('batch_no'); ?> <small class="req" style="color:red;">*</small></th>
                                                    <th width="12%"><?php echo $this->lang->line('expiry_date'); ?><small class="req" style="color:red;"> *</small></th>
                                                    <th class="text-right" width="10%"><?php echo $this->lang->line('quantity'); ?><small class="req" style="color:red;"> *</small> <?php echo " | " . $this->lang->line('available_qty'); ?></th>
                                                    <th class="text-right" width="10%"><?php echo $this->lang->line('sale_price') . ' (' . $currency_symbol . ')'; ?><small class="req" style="color:red;"> *</small></th>
                                                    <th class="" width="10%"><?php echo $this->lang->line('tax'); ?></th>
                                            ...
                                            <tr id="row1">
                                                ...
                                                <td>
                                                    <select class="form-control select3 medicine_name" style="width:100%"  id="medicine_name1" name='medicine_name_id_1'>
                                    ...
                                    <select class="form-control batch_no select3" style="width:100%" id="batch_no1" name="batch_no_id_1" >
                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                ...
                                                <span class="input-group-addon text-danger available_qty" style="font-size: 10pt" id="totalqty1">&nbsp;&nbsp;</span>
                                                    </div>
                                                    <input type="hidden" class="available_quantity" name="available_quantity_1" id="available_quantity1">                                                 
                                                </td>
                                                <td class="text-right">
                                                    <input type="hidden" name="sale_rate_price_1" id="sale_rate_price1"  class="form-control text-right sale_rate" readonly>
                                                    <input type="hidden" name="tpa_rate_1" id="tpa_rate1"  class="form-control text-right tpa_rate" readonly>
                                                    
                                                    <input type="text" name="sale_price_1" id="sale_price1"  class="form-control text-right price" readonly>
                                                ...
                                                <td class="text-right w-100px">
                                                    <input type="text" name="amount_1" id="amount1" placeholder="" class="form-control text-right subtot" value='0.00' readonly>
...
<?php }?>
                                        ...
                                        <div class="col-sm-6">
                                            <table class="printablea4">
                                                ...
                                                <input type="text" placeholder="<?php echo $this->lang->line('discount'); ?> Gross" name="discount_percent" id="discount_percent" class="form-control discount_percent" style="width: 70%; float: right;font-size: 12px;"/></td>
                                                    <td class="text-right ipdbilltable">
