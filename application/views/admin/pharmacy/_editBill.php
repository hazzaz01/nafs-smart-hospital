         ...
         <option value="<?php echo $med_cat_value["id"]; ?>" <?php echo set_select('medicine_category_id_<?php echo $row_value;?>', $med_cat_value['id'], ($med_cat_value["id"] == $bill_detail_value['medicine_category_id']) ? TRUE :FALSE); ?>><?php echo $med_cat_value["medicine_category"] ?>
                    ...
                    <option value=""><?php echo $this->lang->line('select') ?>
                                    ...
                                    <option value=""><?php echo $this->lang->line('select') ?></option>
                                                ...
                                                <td class="text-right">
                                                    <input type="hidden" name="sale_rate_price_<?php echo $row_value;?>" id="sale_rate_price<?php echo $row_value;?>"  class="form-control text-right sale_rate" readonly>
                                                    <input type="hidden" name="tpa_rate_<?php echo $row_value;?>" id="tpa_rate<?php echo $row_value;?>"  class="form-control text-right tpa_rate" readonly>
...
<?php }?>
                ...
                <input type="text" placeholder="Total" value="<?php echo $bill['total'];?>" name="total" id="total" style="width: 30%; float: right" class="form-control total"/></td>
                                                ...
                                                <input type="text" placeholder="<?php echo $this->lang->line('discount'); ?> Gross" name="discount_percent" id="discount_percent" class="form-control discount_percent" value="<?php echo $bill['discount_percentage'] ?>" style="width: 70%; float: right;font-size: 12px;"/></td>											
                                         <td class="text-right ipdbilltable">
                                        <input type="text" placeholder="<?php echo $this->lang->line('discount'); ?>" onkeyup="get_percentage(this.value)" value="<?php echo $bill['discount'];?>" name="discount" id="discount" style="width: 50%; float: right" class="form-control discount"/></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right ipdbilltable">
                                                        <input type="text" placeholder="<?php echo $this->lang->line('tax'); ?>" name="tax" value="<?php echo $bill['tax'] ?>" id="tax" style="width: 50%; float: right" class="form-control tax" readonly/>
                                                    </td>
                                                </tr>
                                                <tr>
