        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
           <table class="table table-hover table-sm">
            <tbody>
                ...
                <tr>
                    <td><?php echo $this->lang->line('tpa');?></td>
                    <td><?php echo $pharmacy_bill_detail['organisation_name']; ?></td>
                </tr>
                <tr>
                    <td><?php echo $this->lang->line('tpa_id');?></td>
                    <td><?php echo $pharmacy_bill_detail['insurance_id']; ?></td>
                </tr>
                 <tr>
                    <td><?php echo $this->lang->line('tpa_validity');?></td>
                    <td><?php echo $this->customlib->YYYYMMDDTodateFormat($pharmacy_bill_detail['insurance_validity']); ?></td>          
                </tr>
            </tbody>
            </table>  
         </div>   
        ...
        <table class="table table-hover table-sm">
            <tbody> 
                ...
                <tr>
                    ...
                    <td class="text-right"><?php echo $pharmacy_bill_detail['discount']." (".$pharmacy_bill_detail['discount_percentage'] ."%)"; ?></td>
                </tr>
                <tr>
                    <td class="text-right"><?php echo $this->lang->line('tax'). " (" . $currency_symbol . ")";?></td>
                    <td class="text-right"><?php //echo $pharmacy_bill_detail['tax'];
                     echo $pharmacy_bill_detail['tax'] ." (".amountFormat(($pharmacy_bill_detail['tax'] * 100) / ($pharmacy_bill_detail['total'] - $pharmacy_bill_detail["discount"]), 2)."%)";   
                     ?></td>
                </tr>
                <tr>
