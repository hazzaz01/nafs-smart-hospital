...
<div class="table-responsive-sm-print">
...
<div id="html-2-pdfwrapper" class="p-1">
    <div class="row">
        <!-- left column -->
        <div class="col-md-12">
            <div class="white-space-nowrap" style="padding-top:10px;">
                <table width="100%">
                    <tr>
                ...
                <table class="printablea4" cellspacing="0" cellpadding="0">
                    <tr>
                ...
                <table id="testreport" width="100%">
                    <tr>
                        <th class="hide"><?php echo $this->lang->line('medicine_category'); ?></th>
                        <th width="20%"><?php echo $this->lang->line('medicine_name'); ?></th>
                        <th><?php echo $this->lang->line('batch_no'); ?></th>
                        <th  class="hide"><?php echo $this->lang->line('unit'); ?></th>
                    ...
                    ?>
                        <tr>
                            <td  class="hide"><?php echo $bill["medicine_category"]; ?></td>
                            <td width="20%"><?php echo $bill["medicine_name"]; ?></td>
                            <td ><?php echo $bill["batch_no"]; ?></td>
                            <td  class="hide"><?php echo $bill["unit_name"]; ?></td>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">  
                        <table class="printablea4" width="100%" cellpadding="0" cellspacing="0"> 
                            ...
                            ?>
                                <tr>
									<th class="text-right rtl-text-left"><?php echo $this->lang->line('total_discount') ; ?></th>
                                    <td class="text-right rtl-text-left"><?php echo amountFormat($result["discount"]); ?><?php echo " (" . $result["discount_percentage"] ."%)"; ?></td> 
                            ...
                            ?>
                                <tr>
									<th class="text-right rtl-text-left"><?php  echo $this->lang->line('total_tax') . " (" . $currency_symbol . ")"; ?></th>
                                    <td class="text-right rtl-text-left"><?php 
                                    // echo amountFormat($result["tax"]);; 

                                    echo $result['tax'] ." (".amountFormat(($result['tax'] * 100) / ($result['total'] - $result["discount"]), 2)."%)";   
                            ...
                            ?>
                            <tr>
                                <th class="text-right rtl-text-left"><?php echo $this->lang->line('total_paid') . " (" . $currency_symbol . ")";  ?></th>
                            ...
                            <tr>
                               <th class="text-right rtl-text-left"><?php echo $this->lang->line('due') . " (" . $currency_symbol . ")"; ?></th>
