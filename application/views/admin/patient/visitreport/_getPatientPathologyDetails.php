        ...
        <div class="col-md-3">
          ...
          <tr>        
            ...
            <td class="col-lg-3 text text-right"><?php if (!empty($result->discount)) {
              echo $currency_symbol.$result->discount." (".amountFormat($result->discount_percentage)."%)" ;
            }  ?></td>
          </tr>
          <tr>         
            ...
            if (!empty($result->total)) {
                echo " (".amountFormat(($result->tax*100)/($result->total-$result->discount))."%)";
            }  ?></td>
          </tr>        
          <tr>   
        ...
        <table class="table table-hover table-sm">
                             <thead>
                                <tr class="line">
                                   ...
                                   <td><?php echo $this->lang->line('approved_by'); ?>/<?php echo $this->lang->line('approved_date'); ?></td>
