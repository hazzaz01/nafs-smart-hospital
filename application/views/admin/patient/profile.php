                                            ...
                                            <div class="col-lg-9 col-md-8 col-sm-12">
                                                <table class="table table-bordered mb0">
                                                   ...
                                                   <tr>
                                                        ...
                                                        <td><img src="<?php echo $this->media_storage->getImageURL("./uploads/patient_id_card/barcodes/" . $patient_id . ".png"); ?>" width="100" height="30" />
                                                        </td>
                                                    </tr>
                                                    
                                                    <tr>
                                                        <td class="bolds"><?php echo $this->lang->line('qrcode'); ?></td>
                                                        <td><img class="h-50" src="<?php echo $this->media_storage->getImageURL("./uploads/patient_id_card/qrcode/" . $patient_id . ".png"); ?>"  width="70" height="70"  /></td>
                                                    </tr>                                                 
                                            ...
                                            <div class="media">
                                                <div class="media-left">
                                                    <?php if($doc_value['image']!=""){ ?>
                                                        ...
                                                        <img src="<?php echo $this->media_storage->getImageURL("uploads/staff_images/".$doc_value['image']); ?>" class="member-profile-small media-object"></a>
                                                    <?php }else{ ?>
                                                          <a  href="<?php echo base_url().'admin/staff/profile/'.$doc_value['id']; ?>"> <img src="<?php echo $this->media_storage->getImageURL("uploads/staff_images/no_image.png") ?>" class="member-profile-small media-object"></a>
                                                    <?php } ?>                                                     
                                                </div>
                                                ...
                                                <?php if($value['timeline_date']){
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="timeline-item">
                                                            ...
                                                            <span class="time">
                                                                <a class="defaults-c text-right" data-toggle="tooltip" title="" href="<?php echo base_url() . "admin/timeline/download_patient_timeline/" . $value["id"]; ?>" data-original-title="<?php echo $this->lang->line('download'); ?>"><i class="fa fa-download"></i></a></span>
                                                            <?php } ?>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content mx-2">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="modal-title" id="modal_head"><?php echo $this->lang->line('lab_investigation_details'); ?></h4> 
            </div>
