                                            ...
                                            <div class="form-group mb0">
                                                ...
                                                <select class="form-control select2" name="diagnosis" style="width: 100%">
                                                    ...
                                                    <?php foreach ((array) $diagnosis_options as $diagnosis_option) { ?>
                                                        <option value="<?php echo html_escape($diagnosis_option); ?>" <?php echo $result->diagnosis === $diagnosis_option ? 'selected' : ''; ?>><?php echo html_escape($diagnosis_option); ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </td>
...
<input type="hidden" name="post_dosage_id" value="<?php echo $medicine_value->dosage_id; ?>" class="post_dosage_id">
                    ...
                    <option value="<?php echo set_value('medicine_category_id'); ?>"><?php echo $this->lang->line('select') ?>
                                    ...
                                    <td>    
                                        <button type="button" class="closebtn delete_row_prescription" data-row-id="<?php echo $medicine_row?>" data-record-id="<?php echo $medicine_value->ipd_prescription_detail_id ;  ?>" autocomplete="off"><i class="fa fa-remove"></i></button>       
                                    </td>
                                </tr>
                                   <?php
                                   ++$i ;
