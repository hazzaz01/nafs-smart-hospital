                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 border-r">
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-12 ptt10">                                                
                                            <?php
                                                $image = $result['image'];
                                                    ...
                                                    ?>
                                            <img width="115" height="115" class="profile-user-img img-responsive img-rounded" src="<?php echo $this->media_storage->getImageURL($file); ?>" >
                                            ...
                                            <div class="col-lg-9 col-md-8 col-sm-12">
                                                <table class="table table-bordered mb0">
                                                   <tr>
                                                    ...
                                                    <tr>
                                                        <!-- AS OF DATE ON THE BASIS OF CURRENT DATE LOGIC SECTION START -->
                                                        <td class="bolds"><?php echo $this->lang->line('age'); ?></td>
                                                        <td><?php 
                                                        echo $this->customlib->get_patient_current_age($result['patient_id']);
                                                         ?>
                                                        </td>
                                                        <!-- AS OF DATE ON THE BASIS OF CURRENT DATE LOGIC SECTION START -->
                                                    </tr>
                                                   ...
                                                   <tr>
                                                        ...
                                                        <td><a href="<?php echo $this->media_storage->getImageURL("./uploads/patient_id_card/barcodes/" . $id . ".png"); ?>" target="_blank"><img src="<?php echo $this->media_storage->getImageURL("./uploads/patient_id_card/barcodes/" . $id . ".png"); ?>" width="100" height="30" /></a>
                                                        </td>
                                                    </tr>
                                                    <?php  ?>
                                                    <?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="<?php echo $this->media_storage->getImageURL("./uploads/patient_id_card/qrcode/" . $id . ".png"); ?>" target="_blank"><img class="h-50" src="<?php echo $this->media_storage->getImageURL("./uploads/patient_id_card/qrcode/" . $id . ".png"); ?>"  width="70" height="70"  /></a></td>
                                                    </tr>   
                                                    <?php   ?>                                                       
                                                </table>
                                            </div><!--./col-lg-7-->
                                    ...
                                    <div class="staff-members"> 
										...
										<?php if($doctor_restriction != 'enabled'){ ?> 
											<?php 
                                            ...
                                            <div class="media">
                                                <div class="media-left">
                                                    <?php if($value['image']!=""){ ?>
                                                        <a href="#">
                                                        <img src="<?php echo $this->media_storage->getImageURL("uploads/staff_images/".$value['image']); ?>" class="member-profile-small media-object"></a>
                                                    <?php }else{ ?>
                                                          <img src="<?php echo $this->media_storage->getImageURL("uploads/staff_images/no_image.png") ?>" class="member-profile-small media-object"></a>
                                                    <?php } ?>                                                     
                                                </div>
										...
										<?php }else{ ?> 
											<?php 
											if(!empty($patientdetails['patient']['doctor'])){
											foreach($patientdetails['patient']['doctor'] as $value ){ if($logged_staff_id == $value['id']){ ?>
                                            <div class="media">
                                                <div class="media-left">
                                                    <?php if($value['image']!=""){ ?>
                                                        <a href="#">
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="timeline-item">
                                                                <?php if (!empty($value["document"])) {?>
                                                                    <span class="time"><a class="defaults-c text-right btn btn-default btn-xs" data-toggle="tooltip" title="" href="<?php echo base_url() . "admin/timeline/download_patient_timeline/" . $value["id"];?>" data-original-title="<?php echo $this->lang->line('download'); ?>"><i class="fa fa-download"></i></a></span>
                                                                <?php }?>
                                 ...
                                 <div class="col-lg-6 col-md-6 col-sm-12">
                                         ...
                                         <?php 
                                            ...
                                            if (!empty($charges_detail)) {
                                                ...
                                                foreach ($charges_detail as $charges_key => $charges_value) {
                                                    ...
                                                    $discount_amt=(($charges_value['apply_charge']*$charges_value["discount_percentage"])/100);
                                                    $tax_amount = (($charges_value['apply_charge']-$discount_amt)*$charges_value['tax']/100) ;
                                                ...
                                                ?>  
                                                    <tr>                                                       
                                                        ...
                                                        <td class="text-right"><?php echo amountFormat($discount_amt)." (".$charges_value["discount_percentage"]."%) " ;?></td>
                                                        <td class="text-right"><?php echo amountFormat($taxamount)." (".$charges_value["tax"]."%) ";?></td>
                                    ...
                                    if (empty($visitconferences)) {
                                        ...
                                        foreach ($visitconferences as $conference_key => $conference_value) {
                                             ++$i;
                                             if($i <= $recent_record_count){
                                                $return_response = json_decode(json_encode($conference_value->return_response),true);
                                            ?>
                                            <tr>
                                    ...
                                    <tr>
                                        ...
                                        $date = $this->customlib->YYYYMMDDTodateFormat($medication_value['date']);
                                            ...
                                            if($subcount==1){ 
                                                ...
                                                echo $date."<br>(".$this->lang->line(strtolower(date('l', strtotime($medication_value['date'])))).")";
                                            }else{
                                            ...
                                            if (!empty($charges_detail)) {
                                                ...
                                                ?>  
                                                    <tr>
                                                        ...
                                                        <td class="text-right"><?php echo amountFormat(round($discount_amount,2))." (".$charges_value["discount_percentage"]."%) " ;?></td>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="timeline-item">                                                
                                                        ...
                                                        <?php if (!empty($value["document"])) { ?>       
                                                            ...
                                                            <span class="time">
                                                            <a target="_blank" class="defaults-c text-right btn btn-default btn-xs" data-toggle="tooltip" title="" 
                                                            href="<?php echo $this->customlib->getBaseUrl()."uploads/patient_timeline/" . $value["document"] ?>" data-original-title="<?php echo $this->lang->line('view'); ?>"><i class="fa fa-reorder"></i></a>
                                                            </span>                                                            
                                                            <?php } ?>
                                            ...
                                            <div class="col-sm-6">
                                                <table class="printablea4">
                                                    ...
                                                    <input type="text" placeholder="<?php echo $this->lang->line('discount'); ?>" name="editdiscount_percentage" id="editdiscount_percentage" class="form-control editdiscount_percentage discount_percentage_add_charge "  style="width: 70%; float: right;font-size: 12px;"/></td>
                                                        <td class="text-right ipdbilltable">
                                                            <input type="text" onkeyup="update_percentage(this.value)" placeholder="<?php echo $this->lang->line('discount'); ?>" name="discount_percentage" value="0" id="editdiscount" style="width: 50%; float: right" class="form-control discount discount_percentage_amount" />
                                                        </td>
                                                    </tr>                                                
                                                    <tr>
                                            ...
                                            <table class="printablea4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right ipdbilltable"><h4 style="float: right;font-size: 12px; padding-left: 5px;"> %</h4>
                                                        <input type="text"  value="0" placeholder="<?php echo $this->lang->line('discount_percentage'); ?>" name="discount_percentage" id="discount_percentage_add_charge" class="form-control discount_percentage_add_charge"  style="width: 70%; float: right;font-size: 12px;"/>
                                                    </td>
                                                    
                                                    <td class="text-right ipdbilltable">
                                                        <input type="text" onkeyup="get_percentage(this.value)" placeholder="<?php echo $this->lang->line('discount'); ?>" name="discount_percentage_amount" value="0" id="discount_percentage_amount" style="width: 50%; float: right" class="form-control discount_percentage_amount" />
                                                    </td>
                                                </tr>
...
<script type="text/javascript">
   ...
   $('#myaddMedicationModal').on('hidden.bs.modal', function () {
       ...
       var $this = $(this);
        ...
        $.ajax({
            ...
            success: function (data) {
				...
				var print_button ="<a href='#'' onclick='getopdrecheckupDetails_print(" + visitid + ")'   data-original-title='<?php echo $this->lang->line('print'); ?>' title='<?php echo $this->lang->line('print'); ?>'><i class='fa fa-print'></i></a>";				
				
                $('#edit_delete').html(print_button+"<?php if ($this->rbac->hasPrivilege('visit', 'can_edit')) { ?><a href='#'' onclick='editRecord(" + visitid + ")' data-target='#editModal' data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa fa-pencil'></i></a><?php } ?><?php if ($this->rbac->hasPrivilege('visit', 'can_delete')) { ?>"+delete_action+"<?php } ?>" );
    ...
    $(document).on('click','.add-record',function(){
        ...
        var table_row= "<tr id='row" + prescription_rows + "'><td>" + div + "</td><td><button type='button' data-row-id='"+prescription_rows+"' class='closebtn delete_row_prescription'><i class='fa fa-remove'></i></button></td></tr>";
