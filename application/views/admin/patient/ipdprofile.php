                            ...
                            ?>
                                                ...
                                                <table class="table table-bordered mb0">
                                                   <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a class="" href="<?php echo $this->media_storage->getImageURL("./uploads/patient_id_card/barcodes/" . $patient_id . ".png"); ?>" target="_blank"><img src="<?php echo $this->media_storage->getImageURL("./uploads/patient_id_card/barcodes/" . $patient_id . ".png"); ?>" width="100" height="30"  /></a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="bolds"><?php echo $this->lang->line('qrcode'); ?></td>
                                                        <td>
                                                            <a class="" href="<?php echo $this->media_storage->getImageURL("./uploads/patient_id_card/qrcode/" . $patient_id. ".png"); ?>" target="_blank"><img class="max-h-50" src="<?php echo $this->media_storage->getImageURL("./uploads/patient_id_card/qrcode/" . $patient_id. ".png"); ?>" width="70" height="70" /></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div><!--./col-lg-7-->
                                        ...
                                        <div class="staff-members">
                                            <div class="media">
                                                <div class="media-left">
                                                      <?php if($result['doctor_image']!=""){ ?>
                                                        ...
                                                        <img src="<?php echo $this->media_storage->getImageURL("uploads/staff_images/".$result['doctor_image']) ?>" class="member-profile-small media-object"></a>
                                                    <?php }else{ ?>
                                            ...
                                            <?php
											  ...
											  <?php if($roles == 7){ ?> 
                                                ...
                                                <div class="media-left">
                                                    <?php if($dvalue['image']!=""){ ?>
                                                        ...
                                                        <img src="<?php echo $this->media_storage->getImageURL("uploads/staff_images/".$dvalue['image']); ?>" class="member-profile-small media-object"></a>
                                                    <?php }else{ ?>
                                                          <img src="<?php echo $this->media_storage->getImageURL("uploads/staff_images/no_image.png") ?>" class="member-profile-small media-object"></a>
                                                    <?php } ?>                                                     
                                                </div>
											  ...
											  <?php } else if($logged_staff_id == $dvalue['id'] || $roles != 7 || $doctor_restriction == 'disabled'){ ?> 
                                                 <div class="media">
                                                <div class="media-left">
                                                    <?php if($dvalue['image']!=""){ ?>
                                                        <a href="<?php echo base_url(); ?>admin/staff/profile/<?php echo $dvalue['consult_doctor']; ?>">
                                        ...
                                        <div id="timeline_list">
                                            <ul class="timeline timeline-inverse">
                                                <?php
                                                    ...
                                                    <li class="time-label">
                                                        <span class="bg-blue">    
                                                <?php echo date($this->customlib->getHospitalDateFormat(true, true), strtotime($timeline_list[$i]['timeline_date'])); ?>
                                                </span>
                                                    </li> 
                                                    <li>
                                                        <i class="fa fa-list-alt bg-blue"></i>
                                                        <div class="timeline-item">
                                                            ...
                                                            <?php if (!empty($timeline_list[$i]["document"])) { ?>
                                                                <span class="time"><a class="defaults-c text-right" data-toggle="tooltip" title="" href="<?php echo base_url() . "admin/timeline/download_patient_timeline/" . $timeline_list[$i]["id"]; ?>" data-original-title="<?php echo $this->lang->line('download'); ?>"><i class="fa fa-download"></i></a></span>
                                                            <?php } ?>
                                                ...
                                                <?php  echo  date($this->customlib->getHospitalDateFormat(true, true), strtotime($value['timeline_date']));  ?></span>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="timeline-item">
                                                            ...
                                                            href="<?php echo base_url()."admin/timeline/download_patient_timeline/".$value["id"]; ?>" data-original-title="<?php echo $this->lang->line('download'); ?>">
                                            ...
                                            <?php                                        
                                                ...
                                                foreach ($charges as $charge) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right"><?php echo number_format($discount_amount,2)." (".$charge["discount_percentage"]."%) "; ?></td>
                                        ...
                                        <div class="col-sm-5 mb10">
                                            <table class="printablea4">
                                                ...
                                                <tr>
                                                    ...
                                                    <input type="text"  onkeyup="get_percentage(this.value)"  placeholder="<?php echo $this->lang->line('discount_percentage'); ?>" name="discount_percentage_amount" value="0" id="discount_percentage_amount" style="width: 50%; float: right" class="form-control discount_percentage_amount" /></td>
                                                </tr>
                                                <tr>
                                            ...
                                            <div class="col-sm-6 mb10">
                                                <table class="printablea4">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right ipdbilltable">
                                                            <h4 style="float: right;font-size: 12px; padding-left: 5px;"> %</h4>
                                                    <input type="text" placeholder="<?php echo $this->lang->line('discount_percentage'); ?>" name="editdiscount_percentage" id="editdiscount_percentage" class="form-control discount_percentage_add_charge"  style="width: 70%; float: right;font-size: 12px;"/>
                                                    </td>
                                                        <td class="text-right ipdbilltable">
                                                            <input type="text"  onkeyup="update_percentage(this.value)" placeholder="<?php echo $this->lang->line('discount'); ?>" name="discount_percentage" value="0" id="editdiscount" style="width: 50%; float: right" class="form-control discount_percentage_amount"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th><?php echo $this->lang->line('tax') . " (" . $currency_symbol . ")"; ?></th>
                                            ...
                                            <div class="row" id="evpatientDetails" style="display:none">
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-3"> 
                                                    <div class="pull-right">
                                                        ...
                                                        $file = "uploads/patient_images/no_image.png";
                                                        ?>        
                                                        <img class="profile-user-img img-responsive" src="<?php echo $this->media_storage->getImageURL($file) ?>" id="evimage" alt="User profile picture">
                                                    </div>           
                                                </div>
                                            </div>
                                            <div class="row">
    ...
    <div class="modal-dialog pup100" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="antenatal_ipdprescription" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                ...
                <div class="modal-footer sticky-footer">
                    <div class="pull-right">                        
                        <button type="submit" name="save" value="save" id="save_antenatal_btn" data-loading-text="<?php echo $this->lang->line('processing'); ?>" class="btn btn-info"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?>
                        </button>
                    </div>
                </div>
            </form>
            ...
            type:"POST",
             beforeSend: function() {
               ...
               success: function (res) {
                ...
                $('#compose-textareanew,#compose-textareas','#add_prescription').wysihtml5({
                    toolbar: {
                        "image": false,
                    }
                });
...
<script>
    ...
    $("#antenatal_ipdprescription").on('submit', (function (e) {
            ...
            $.ajax({
                ...
                processData: false,
                beforeSend: function() {
                    $("#save_antenatal_btn").button('loading');
                },
                success: function (data) {
                    if (data.status == "0") {
                        var message = "";
                 ...
                 error: function(xhr) { // if error occured
                    alert("Error occured.please try again");
                   $("#save_antenatal_btn").button('reset');
                },
                 complete: function() {
                     $("#save_antenatal_btn").button('reset');
                 }
