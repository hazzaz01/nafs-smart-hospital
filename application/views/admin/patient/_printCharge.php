                             ...
                             <tbody>
                                <tr>
                                   ...
                                   <td><?php echo $charge->charge_name ?><br>
                                    ...
                                    echo amountFormat($discount_amount)." (".$charge->discount_percentage."%)";?></td>                             
                                    <td>
                                    <?php 							
								...
								<tr>
                                    ...
                                    <td class="text-right no-line"><?php echo $currency_symbol . amountFormat((($charge->apply_charge * $charge->discount_percentage / 100)))." (".$charge->discount_percentage."%)"; ?></td>
                                </tr>                                      
                                <tr>                                   
