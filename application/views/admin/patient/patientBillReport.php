                    ...
                    <div class="box border0 clear">
                        ...
                        <div class="box-body table-responsive" id="bill_report">
                            ...
                            <div class="pull-right pt4">
                                <a class="btn btn-default btn-xs pull-right" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('export_to_excel'); ?>"  id="btnExport" onclick="exportToExcel();"> <i class="fa fa-file-excel-o"></i></a>
                                <a class="btn btn-default btn-xs pull-right " data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('print'); ?>"  id="print" onclick="printDiv()" ><i class="fa fa-print"></i></a> 
                            </div>    
                            <table class="table table-striped table-bordered table-hover allajaxlist" id="headerTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-right rtl-text-left"><?php echo $this->lang->line('payment_amount')."(".$currency_symbol.")"; ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right rtl-text-left"><b><?= $this->lang->line("total_payment"); ?>: </b><?php echo $currency_symbol.''. amountFormat($total); ?></td>
                                        <?php 
                                    ...
                                    ?>
                                     <tr>
                                        <?php if(isset($grand_total_charge) && isset($grand_total_payment)){ ?>
                                            ...
                                            <td class="text-right rtl-text-left"><b><?php echo $this->lang->line("grand_total_payment"); ?>: </b>
