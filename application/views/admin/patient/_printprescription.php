        ...
        <div class="row">
            ...
            <div class="col-md-12">               
                <div>
                    ...
                    <table width="100%" class="noborder_table mb-10" style="margin-bottom:10px;" >
                             <tr>
                                <th width="25%" style="padding-left: 0;"><?php echo $this->lang->line("opd_id"); ?></th>
                        ...
                        <tr>
                            <th width="25%" style="padding-left: 0;"><?php echo $this->lang->line("patient_name"); ?></th>
                        ...
                        <tr>                            
                            <th width="25%" style="padding-left: 0;"><?php echo $this->lang->line("gender"); ?></th>
                        ...
                        <tr>                       
                            <th width="25%" style="padding-left: 0;"><?php echo $this->lang->line("phone"); ?></th>
                        ...
                        <tr>                           
                            <th width="25%" style="padding-left: 0;"><?php echo $this->lang->line("email"); ?></th>
                        ...
                        <tr>
                            ...
                            <td width="50%"><?php $sl=''; foreach ($result->tests as $test_key => $test_value) {  ?>
                                <table >   
                                    ...
                                    <td style="padding: 2px;"><?php echo $sl.'. '.$test_value->test_name." (".$test_value->short_name.")"; ?></td></tr>        
                                    <?php } ?>                             
                                </table>    
                                <?php } ?>
                            </td>
                            ...
                            <td  width="50%"><?php $slradiology=''; foreach ($result->tests as $test_key => $test_value) {  ?>
                                <table>   
                                    ...
                                    <td style="padding: 2px;"><?php echo $slradiology.'. '.$test_value->radio_test_name." (".$test_value->radio_short_name.")"; ?></td> </tr>                                 
                                    <?php } ?>                             
                                </table>   
                                <?php } ?>
                            </td>
                    ...
                    <table width="100%">
                        <tr>
                            <td><br><?php echo $result->footer_note; ?></td>
                        </tr>
                    </table>
                    <div class="divider mb-10 mt-10"></div>
                    <?php } ?>
