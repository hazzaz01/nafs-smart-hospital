...
?>
                                            ...
                                            <div class="dual-list list-right">
                                                <div class="well minheight260">
                                                    ...
                                                    <div class="">
                                                        <ul class="list-group send_list dual-list-scroll">
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
			...
			<div class="modal-content m-0 bg-transparent modal-body-scroll">
				<div class="modal-gradient">
					<div class="modal-header bg-transparent p0 border0">
						...
						<a href="#" class="pdfdownload-icon"  data-placement="bottom" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('download'); ?>"><i class="fa fa-download"></i></a>
	...
	$(document).on('click', '.add-btn', function () {
        ...
        if (record_id != "" && category_selected != "") {
            ...
            if (chkexists) {
                ...
                $("#search-query").attr('data-record', "");
                $(".send_list").append('<li class="list-group-item" id="' + category_selected + '-' + record_id + '"><i class="fa fa-user"></i> <span>' + value + ' (' + word + ')</span> <i class="glyphicon glyphicon-trash pull-right text-danger" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_record(' + "'" + category_selected + '-' + record_id + "'" + ')"></i></li>');
            } else {
