        ...
        <div class="row">
            <div class="col-md-12 ptt10">
                ...
                ?>
                    ...
                    ?>
                        <a href="<?php echo site_url('site/download_content/'.$shared_content_value->upload_content_id."/".$this->enc_lib->encrypt($shared_content_value->share_content_id))?>" > <?php echo $shared_content_value->real_name; ?> <i class="fa fa-download"  data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('download'); ?>"></i></a>                        
                    <?php
                        }
                    ?>    
                    </li>
