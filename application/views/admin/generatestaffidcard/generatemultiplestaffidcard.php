        ...
        foreach ($staffs as $staff_value) {
            ...
            <td valign="top" class="width32">
                <table cellpadding="0" cellspacing="0" width="100%" class="tc-container" style="background: #f0f8fd;">
                    <tr>
                        <td valign="top">
                            <img src="<?php echo $this->media_storage->getImageURL('uploads/staff_id_card/background/' . $id_card[0]->background); ?>" class="tcmybg" /></td>
                    </tr>
                    <tr>
                        <td valign="top">
                            ...
                            <div class="staround">
                                <div class="cardleft">
                                    <div class="stimg">
                                        ...
                                        <img src="<?php echo $this->media_storage->getImageURL('uploads/staff_images/'.$staff_value->image); ?>" class="img-responsive" />
                                        <?php }else{ ?>
                                        <img src="<?php echo $this->media_storage->getImageURL('uploads/patient_images/no_image.png'); ?>" class="img-responsive" />
                                        <?php } ?>
                                    </div>
                                    <?php if ($id_card[0]->enable_staff_barcode == 1) { ?>
                                     <div class="barcodeimg" style="width: 90%;margin:0 auto">
                                        <img src="<?php echo $this->media_storage->getImageURL($staff_value->barcode); ?>" style="max-width: 65px; margin: 0 auto; height:auto;" />
                                     </div>
                                 <?php } ?>
                                </div><!--./cardleft-->
                                <div class="cardright">
