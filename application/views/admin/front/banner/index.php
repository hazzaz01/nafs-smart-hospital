...
if ($this->rbac->hasPrivilege('banner_images', 'can_view')) {
            ?>
                                                    <img class='img-responsive' data-fid='<?php echo $banner_image_value->id ?>' data-content_name='<?php echo $banner_image_value->img_name; ?>' data-img='<?php echo base_url($banner_image_value->thumb_path . $banner_image_value->img_name) ?>' src='<?php echo $this->media_storage->getImageURL($banner_image_value->thumb_path . $banner_image_value->img_name) ?>'>
                                                    <?php }
