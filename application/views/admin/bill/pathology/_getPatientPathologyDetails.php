    ...
    <div class="row">
        ...
        <div class="col-md-2">
          <table class="table table-hover table-sm">       
            ...
            <tr>
              <td><label><?php echo $this->lang->line('prescription_no'); ?></label></td>
        ...
        <div class="col-md-3">
          ...
          <tr>         
            ...
            <td class="col-lg-3 text text-right"><?php if (!empty($result->tax)) {
              ...
              echo $currency_symbol.$result->tax.' ('.amountFormat($tax_per).'%)' ;
            }  ?></td>
          </tr>        
          <tr>   
        ...
        <table class="table table-hover table-sm">
                             <thead>
                                <tr class="line">
                                   ...
                                   <td><strong><?php echo $this->lang->line('approved_by'); ?>/<?php echo $this->lang->line('approved_date'); ?></strong></td>
