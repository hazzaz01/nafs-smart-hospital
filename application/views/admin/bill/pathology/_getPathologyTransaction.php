        ...
        <div class="col-lg-8 col-md-8 col-sm-8">
               <table class="table table-hover table-sm">
                ...
                <tr>
                    ...
                    <td><?php 
                    echo $this->customlib->get_patient_current_age($pathology_billing->patient_id);
                    ?></td>
                </tr>
                <tr>    
                    <td><label><?php echo $this->lang->line('gender'); ?></label></td>
                    <td><?php echo $this->lang->line(strtolower($pathology_billing->gender)); ?></td>      
                </tr>
                <tr>
                ...
                <tr>                   
                    ...
                    <td class="text-right">
                        <?php if (!empty($pathology_billing->discount)) {
                            ...
                            echo " (".amountFormat($pathology_billing->discount_percentage)."%) ";  }  ?>                          
                    </td>
                </tr>                
                 <tr>
                    ...
                    <td class="text-right">    
                        ...
                        $totamt=$pathology_billing->total - $pathology_billing->discount;
                        echo "(".amountFormat(($pathology_billing->tax * 100)/ ($totamt)) ."%)";
                        ?>
                    </td>    
                </tr>    
                 <tr>
