                        ...
                        <div class="nav-tabs-custom border0">
                            <ul class="nav nav-tabs navlistscroll">                             
                                ...
                                <li ><a href="#radiology" onclick="load_radiology_data()" data-toggle="tab" aria-expanded="true"><?php echo $this->lang->line('radiology') ?></a></li>
                                 <?php } if ($this->rbac->hasPrivilege('blood_bank_billing', 'can_view')) { ?>
                                <li ><a href="#blood_bank" onclick="load_blood_bank_data()" data-toggle="tab" aria-expanded="true"><?php echo $this->lang->line('blood_issue') ?></a></li>
								
								<li ><a href="#blood_components" onclick="load_blood_components_data()" data-toggle="tab" aria-expanded="true"><?php echo $this->lang->line('component_issue') ?></a></li>							
   ...
   $(document).on('click','.payment_refund',function(){  
    ...
    $(document).ready(function () {
        initDatatable('load_blood_bank','admin/bill/getbloodbank/'+get_case_id(),[],[],100,
            [
{ "sWidth": "150px", "bSortable": false, "aTargets": [ -1,-2,-3,-4,-5,-6] ,'sClass': 'dt-head-right dt-body-right'}
            ] );
    });
} ( jQuery ) )
}else{
    ...
    $(document).on('click','.view_generate_bill',function(){    
      ...
      $.ajax({
          ...
          success: function(res) {
            ...
            $('#refund_print').html(' <a href="javascript:void(0);"   class=" generate_bill" data-toggle="tooltip" title="<?php echo $this->lang->line("print_bill"); ?>" data-module_type="ipd_opd" data-case_id="'+case_id+'"><i class="fa fa-print"></i> </a> ');
   ...
   function getradioPayments(record_id){
    ...
    function load_ambulance_data(){
        if(get_case_id()!==0){
            ...
            [
{ "sWidth": "150px", "bSortable": false, "aTargets": [ -1,-2,-3,-4,-5,-6,-7] ,'sClass': 'dt-head-right dt-body-right'}
            ] );
                });
            } ( jQuery ) )
        }else{
