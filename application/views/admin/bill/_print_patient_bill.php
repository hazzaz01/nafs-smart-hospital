              ...
              <div class="card">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php
                         echo $this->customlib->get_patient_current_age($patient['patient_id']); 
                         ?></td>
                    </tr>
                    <tr>
...
if(!empty($pharmacy_data)){
    ...
    <thead>
        <tr class="border_top border_bottom">
            ...
            <th class="text-right"><?php echo $this->lang->line('tax'); ?></th>
            <th class="text-right"><?php echo $this->lang->line('refund'); ?></th>
            <th class="text-right"><?php echo $this->lang->line('amount'); ?></th>
        </tr>
    </thead>
    <?php 
    ...
    <tr>
        ...
        <th class="text text-right"><?php echo  $currency_symbol.$pharmacy_value->refund_amount;?></th>
...
if(!empty($pathology_data)){
    ...
    <tbody>
        ...
        <tr>
            ...
            <th class="text text-right">
                <?php if($pathology_value->total > 0){
                ...
                }else { echo $currency_symbol.'0.00 (0.00%)'; }  ?>
            </th>
...
<!-- =======================*****============================== -->
<?php
if(!empty($componentissue_data)){  ?>
<h4 class="ps-2px"><?php echo $this->lang->line('component_issue'); ?></h4>
<table class="noborder_table">
    <thead >
        <tr class="border_top border_bottom">
            <th width="20%" class="ps-1" style="padding-left:0"><?php echo $this->lang->line('bill_no'); ?></th>  
            <th width="20%"><?php echo $this->lang->line('charge'); ?></th>  
            <th width="20%" class="text text-right"><?php echo $this->lang->line('discount'); ?></th>  
            <th width="20%" class="text text-right"><?php echo $this->lang->line('tax'); ?></th>            
            <th class="text text-right"><?php echo $this->lang->line('amount'); ?></th>      
        </tr>
    </thead>
    <tbody>
    <?php    
    foreach ($componentissue_data as $componentissue_key => $componentissue_value) {  
      ...
      ?>
      <tr>
       <th width="20%" class="ps-1" style="padding-left:0"><?php echo $blood_bank_bill_prefix.$componentissue_value['id'];?>  </th>  
       <th width="20%"><?php echo $componentissue_value['standard_charge'];?> </th>  
       <th width="20%" class="text text-right"><?php echo $discount_amount.' ('.$componentissue_value['discount_percentage'].'%)';?>  </th>  
       <th width="20%" class="text text-right"><?php echo $tax_amount.' ('.$componentissue_value['tax_percentage'].'%)';?>  </th>        
       <th class="text text-right"><?php echo $currency_symbol.$componentissue_value['net_amount'];?>  </th>
   </tr>
       <?php
    }
    ?>
...
<h4 class="ps-2px"><?php echo $this->lang->line('ambulance'); ?></h4>
<table class="noborder_table">
    <thead>
        <tr class="border_top border_bottom">
            <th class="ps-1" style="padding-left:0"><?php echo $this->lang->line('bill_no'); ?></th>
            <th><?php echo $this->lang->line('charge'); ?></th>            
            <th class="text text-right"><?php echo $this->lang->line('vehicle_number'); ?></th>           
    ...
    <tbody>
<?php  
    foreach ($ambulance_data as $ambulance_key => $ambulance_value) { 
        if($ambulance_value['case_reference_id'] == $case_id){
         $total_amount+=$ambulance_value['net_amount']; 
            ?>
            <tr>
                <th class="ps-1" style="padding-left:0"><?php echo $this->customlib->getSessionPrefixByType('ambulance_call_billing').$ambulance_value['id'];?></td>
                <th><?php echo $currency_symbol.amountFormat($ambulance_value['amount']);?></th>
                <th class="text text-right"><?php echo $ambulance_value['vehicle_no'];?></th>
                <th class="text text-right"><?php echo amountFormat($ambulance_value['discount']);?> (<?php echo amountFormat($ambulance_value['discount_percentage']); ?>%)</th>
                ...
                echo amountFormat($tax);?> (<?php echo amountFormat($ambulance_value['tax_percentage']); ?>%)</th>               
                <th class="text text-right"><?php echo  $currency_symbol.amountFormat($ambulance_value['net_amount']);?></th>   
            </tr>
        <?php }
        }
        ?>
   ...
   <h4 class="ps-2px"><?php echo $this->lang->line('transactions'); ?></h4>
    ...
    <tbody>
        ...
        <tr>
            ...
            <th><?php if($transaction_value->payment_mode){ echo $this->lang->line(strtolower($transaction_value->payment_mode)); }?></th>
