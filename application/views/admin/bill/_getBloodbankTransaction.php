            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <table class="table table-hover table-sm">
                    ...
                    <tr>     
						...
						echo $currency_symbol.$discount_amount; ?> (<?php echo $blood_issue_detail['discount_percentage'];?>%)</td>
                    </tr>
                    <tr>
                        <th><?php echo $this->lang->line('tax'); ?></th>
						<td class="text text-right"><?php  $amount = $blood_issue_detail['amount']-$discount_amount ; 					
					echo $currency_symbol.calculatePercent($amount,$blood_issue_detail['tax_percentage']) ?> (<?php echo $blood_issue_detail['tax_percentage']; ?>%)
                        </td>
                    </tr> 
                    <tr>                   
