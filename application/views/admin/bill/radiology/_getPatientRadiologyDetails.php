            ...
            <div class="col-md-9">
             ...
             <div class="col-md-3">
                ...
                <tr>                  
                    ...
                    echo $currency_symbol.$result->tax." (".amountFormat((($result->tax/($result->total-$result->discount)))*100)."%)";
                    ?></td>
                </tr>
                <tr>                 
            ...
            <table class="table table-hover table-sm">
                <thead>
                    <tr class="line">
                        ...
                        <td class="text-right"><strong><?php echo $this->lang->line('net_amount'); ?></strong></td>
