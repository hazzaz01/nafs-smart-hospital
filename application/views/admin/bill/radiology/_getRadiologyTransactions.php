 ...
 <div class="row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8">
           <table class="table table-hover table-sm">
            ...
            <tr>
                ...
                <td><?php echo $this->customlib->get_patient_current_age($radio_billing->patient_id); ?></td>
            </tr>
            <tr>     
                <td><label><?php echo $this->lang->line('gender'); ?></label></td>
                <td><?php echo $this->lang->line(strtolower($radio_billing->gender)); ?></td>
            </tr>
            <tr>
    ...
    <table class="table table-hover table-sm">       
            <tbody> 
                ...
                <tr>
                    <td class="text-right"><label><?php echo $this->lang->line('discount');?></label></td>
                    <td class="text-right"><?php echo $currency_symbol.$radio_billing->discount." (".$radio_billing->discount_percentage ."%)"; ?></td>
                </tr>
                <tr>
                    <td class="text-right"><label><?php echo $this->lang->line('tax');?></label></td>
                    <td class="text-right"><?php echo $currency_symbol.$radio_billing->tax." (".amountFormat((($radio_billing->tax/($radio_billing->total-$radio_billing->discount)))*100)."%)"; ?></td>
                </tr>
                <tr>
