                            ...
                            <div class="table-responsive">
                                ...
                                $total_tax+=$tax;
                                     ...
                                     <tr> 
                                       ...
                                       <td class="text-right no-line text-rtl-left"> <?php 
									   $discount_per = ($total_discount*100)/$apply_charge;
									   echo $currency_symbol.amountFormat($total_discount).' ('.amountFormat($discount_per).'%)'; ?></td>
                                    </tr>
                                    <tr> 
									   ...
									   echo $currency_symbol.amountFormat($total_tax).' ('.amountFormat($tax_per).'%)'; ?></td>
                                    </tr>
                                    <tr>
