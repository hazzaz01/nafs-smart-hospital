                            ...
                            <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
                                <div class="new-arrival-product mb-sm-1">
                                    <div class="new-arrivals-img-contnent">
                                        <img class="img-fluid" src="<?php echo $this->media_storage->getImageURL($content_value->image) ?> <?php //echo base_url($content_value->image); ?>" alt="">
										<?php if (!IsNullOrEmptyString($content_value->current_version)) { ?>
                                        <h6 class="mb5"><?php echo $this->lang->line('version'); ?> <span class="price-num ps-1"><?php echo $content_value->current_version; ?></span></h6>
										<?php } ?>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="d-flex align-items-center mb-xl-3 mb-2">
                                            <div class="ms-auto mr-sm-auto">
                                                ...
                                                ?>
                                                    ...
                                                    ?>
                                                        <a href="#" class="btn btn-warning btn-xs" data-addon-version="<?php echo $version; ?>" data-addon="<?php echo $content_value->short_name;?>" data-toggle="modal" data-target="#addonModal"><i class="fa fa-unlock-alt" aria-hidden="true"></i> <?php echo $this->lang->line('register'); ?></a>
