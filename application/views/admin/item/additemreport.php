                            ...
                            <table class="table table-striped table-bordered table-hover allajaxlist" data-export-title="<?php echo $this->lang->line('inventory_item_report'); ?>">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="10%"  class="text text-right"><?php echo $this->lang->line('quantity'); ?></th>
                                        <th width="15%" class="text text-right"><?php echo $this->lang->line('purchase_price') . " (" . $currency_symbol . ")"; ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
