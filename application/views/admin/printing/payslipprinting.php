                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('header_image'); ?>(2230px X 300px)</label>
                                         <input data-default-file="<?php if(!empty($printing_list)){echo $this->customlib->getBaseUrl().$printing_list[0]['print_header'];} ?>" type="file" class="filestyle form-control" data-height="180" name="header_image">
                                        ...
                                        <div class="header_image d-flex pt5"> 
                                            <a class="uploadclosebtn" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash-o pe5 cursor-pointer" onclick="removeheader_image()"></i></a><?php echo $this->media_storage->fileview($printing_list[0]['print_header']); ?>
                                        </div>     
                                        <?php }?>
                                    </div>
