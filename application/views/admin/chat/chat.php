                ...
                <div id="frame">
                    ...
                    <div class="chatcontent">
                        <div class="contact-profile">
                            <img src="<?php echo $this->media_storage->getImageURL('uploads/patient_images/no_image.png'); ?>" alt="" />
...
$(document).on('input','.chat_input',function(){
    ...
    function newUserLi(user_array, chat_connection_id) {
        ...
        if (user_array.user_type == "patient") {
            new_user_type = "Patient";
            img = user_array.image;
        } else if (user_array.user_type == "staff") {
            new_user_type = "Staff";
            img = user_array.image;
        }
        var new_connection_msg='<span><?php echo $this->lang->line('you'); ?>: </span>' +'<?php echo $this->lang->line("you_are_now_connected_on_chat");?>';
        ...
        newli += "<p class='preview'>"+new_connection_msg+"</p>";
        newli += "</div>";
        newli += "</div>";
