                ...
                <li class="contact" data-chat-connection-id="<?php echo $user_value->id; ?>">
                    <div class="wrap">
                        ...
                        if ($user_value->user_details->image == "") {
                            $img =  "uploads/patient_images/no_image.png";
                        } else {
                            $img = ($user_value->user_details->user_type == "staff") ?  "uploads/staff_images/" . $user_value->user_details->image :  $user_value->user_details->image;
                        }
                        ?>
                        ...
                        <div class="meta">
                            ...
                            <p class="preview">
                                ...
                                <?php
                                if($user_value->messages->is_first==1){
                                    echo $this->lang->line("you_are_now_connected_on_chat");
                                }else{  
                                    echo $user_value->messages->message;  
                                }
                                ?>
