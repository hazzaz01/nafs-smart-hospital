                ...
                <div class="card-body">  
                        ...
                        <div class="col-md-6">
							<table class="noborder_table mb-0">	
								...
								<tr>
                                    ...
                                    <td width="35%" ><?php echo $this->lang->line(strtolower($result->gender)); ?></td>
                                </tr>								
							</table>                                                       
                        </div>						
                        <div class="col-md-6 text-left">   
							<table class="noborder_table mb-0">	
								...
								<tr>
                                    ...
                                    <td width="35%"><?php  echo $this->customlib->get_patient_current_age($result->patient_id); ?></td>	
								</tr>								
							</table>
                        </div>					
                    </div>
                    ...
                    <div class="row">
                        ...
                        <tr>
                            ...
                            <td><?php echo $report_value->test_name; ?> <?php echo "(".$report_value->short_name.")"; ?></td>                               
                            <td><?php echo $this->customlib->YYYYMMDDTodateFormat($report_value->reporting_date); ?></td>
                            <td><?php echo calculatePercent($afterdiscount,$report_value->tax_percentage)." (".$report_value->tax_percentage."%)"; ?></td>
                    ...
                    $row_counter++;
                        ...
                        <tr>
						   ...
						   echo $currency_symbol . "" . amountFormat($result->tax).' ('.amountFormat($tax_per) .'%)'; ?></td>
                        </tr>
                           <tr>
                           <td colspan="3" class="no-line"></td>
