                                    ...
                                    <div class="col-sm-6">
                                        <table class="printablea4">
                                            <tr>
                                                ...
                                                <input type="text" placeholder="Total" value="<?php echo $radiology_data->total; ?>" name="total" id="total" style="width: 30%; float: right" class="form-control total" readonly=''/></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td class="text-right ipdbilltable">
                                                    <input type="text" placeholder="Tax" name="tax" value="<?php echo $radiology_data->tax; ?>" id="tax" style="width: 50%; float: right" class="form-control tax" readonly=''/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th><?php echo $this->lang->line('net_amount') . " (" . $currency_symbol . ")"; ?></th>
                                                <td colspan="2" class="text-right ipdbilltable">
                                                    <input type="text" placeholder="Net Amount" value="<?php echo $radiology_data->net_amount; ?>" name="net_amount" id="net_amount" style="width: 30%; float: right" class="form-control net_amount" readonly=''/></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div><!--./row-->
