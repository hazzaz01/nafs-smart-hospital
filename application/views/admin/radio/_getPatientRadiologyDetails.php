            ...
            <div class="col-md-9">
             ...
             <div class="col-md-3">
                ...
                <tr>           
                    ...
                    <td class="text text-right"><?php echo $currency_symbol.$result->discount ?><?php echo " (".$result->discount_percentage."%)" ?></td>
                </tr>
                <tr>                  
                    <th><label><?php echo $this->lang->line('tax'); ?></label></th>
                    <td class="text text-right"><?php 
					$tax_per = $result->tax*100/($result->total-$result->discount);
					echo $currency_symbol.$result->tax.' ('.amountFormat($tax_per).'%)' ?></td>
                </tr>
                <tr>                 
            ...
            <table class="table table-hover table-sm">
                <thead>
                    <tr class="line">
                        ...
                        <td class="text-center"><?php echo $this->lang->line('report_date'); ?></td>
