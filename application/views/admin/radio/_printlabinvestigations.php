                            ...
                            <table class="print-table">
                                ...
                                <tbody>
                                   ...
                                   <tr class="<?php echo $row_cls;?>">
										...
										<td class="text-left"><?php echo  ($level_exceeded)? "<span class='text-danger'>".$parameter_value->radiology_report_value." ".$parameter_value->unit_name."</span>":(($parameter_value->radiology_report_value == "") ? "" :"<span>".$parameter_value->radiology_report_value." ".$parameter_value->unit_name."</span>");  ?></td>
