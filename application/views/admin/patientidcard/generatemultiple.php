<style type="text/css">
    *{ margin:0; padding: 0;}
    ...
    .principal{margin-top:0px;margin-right:10px; float:right;}
    .stred{color: #000;}
                            ...
                            <div class="staround">
                                <div class="cardleft">
                                    <div class="stimg">
                                        ...
                                        <img src="<?php echo $this->media_storage->getImageURL($patient->image); ?>" class="img-responsive" />
                                        <?php } ?>
                                    </div>
                                ...
                                <div class="cardright">
                                    ...
                                    <div class="text-right principal">
