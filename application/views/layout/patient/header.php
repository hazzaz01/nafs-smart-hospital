                            ...
                            <div class="navbar-custom-menu">
                                ...
                                <ul class="nav navbar-nav headertopmenu">
                                    ...
                                    <?php
                                       ...
                                       <?php }else{ ?>
                                            <li class="cal15"><a href="<?php echo base_url() . "patient/systemnotifications" ?>"  data-placement="bottom" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('notifications'); ?>"><i class="fa fa-bell-o"></i>
                                            </a></li>
                                       <?php }?>
                                            ...
                                            <li>
                                                <div class="sstopuser">
                                                    <div class="ssuserleft">
                                                        <a href="<?php echo base_url() . "patient/dashboard/appointment" ?>"><img src="<?php echo $this->media_storage->getImageURL($file); ?>" alt="User Image"></a>
                                                    </div>
                                                    <div class="sstopuser-test">
                                                        ...
                                                        if ($this->module_lib->hasModule('google_authenticator') && $this->module_lib->hasActive('google_authenticator')) { 
                                                            if($this->customlib->checkPatientPanelGoogleAuthenticator()){  ?>
                                                            <p class="sspass">
                                                            <a href="<?php echo site_url('patient/gauthenticate/setup') ?>"><i class="fa fa-cog"></i> 
                                                            <?php echo $this->lang->line('settings'); ?></a></p> 
                                                            <?php } } ?>
                                                    </div>
