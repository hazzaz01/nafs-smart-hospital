    ...
    <section class="sidebar" id="sibe-box">
        ...
        <ul class="sidebar-menu verttop">
           <li class="treeview <?php echo set_Topmenu('dashboard'); ?>">
            ...
            <?php
            $eye_role = json_decode($this->customlib->getStaffRole(), true);
            $eye_role_name = isset($eye_role['name']) ? strtoupper($eye_role['name']) : '';
            if (in_array($eye_role_name, array('DOCTOR', 'SUPER ADMIN'), true)) { ?>
                <li class="treeview <?php echo set_Topmenu('Eye_Examinations'); ?>">
                    <a href="<?php echo site_url('admin/eyeexam'); ?>">
           ...
           if($this->module_lib->hasActive('patient')){
                if ($this->rbac->hasPrivilege('patient', 'can_view')) { ?>
                    <li class="treeview <?php echo set_Topmenu('patient'); ?>">
			...
			<?php  if($this->module_lib->hasModule('multi_branch')){ ?> 
            ...
            <li class="treeview <?php echo set_Topmenu('multibranch'); ?>">
				<a href="#"><i class="fa fa-sitemap ftlayer"></i> <span> <?php echo $this->lang->line('multi_branch'); ?></span> <i class="fa fa-angle-left pull-right"></i></a>
				<ul class="treeview-menu">
					...
					<li class="<?php echo set_Submenu('admin/multibranch/branch/overview'); ?>"><a href="<?php echo site_url('admin/multibranch/branch/overview'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('overview'); ?></a></li>	
					<?php } ?>
					...
					<?php if(($this->rbac->hasPrivilege('multi_branch_appointment_report','can_view')) ||
                        ...
                        ($this->rbac->hasPrivilege('multi_branch_transaction_report','can_view'))||
                        ($this->rbac->hasPrivilege('multi_branch_blood_donor_report','can_view'))  ){ ?>
					<li class="<?php echo set_Submenu('admin/multibranch/branch/report'); ?>"><a href="<?php echo site_url('admin/multibranch/branch/report'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('report'); ?></a></li>
					<?php } ?>
					
					<?php if($this->rbac->hasPrivilege('multi_branch_setting','can_view')){ ?>
					<li class="<?php echo set_Submenu('admin/multibranch/branch'); ?>"><a href="<?php echo site_url('admin/multibranch/branch'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('setting'); ?></a></li>
					<?php } ?>		 
                ...
                if($this->module_lib->hasActive('qr_code_attendence')){			
                    if(($this->rbac->hasPrivilege('qr_code_attendance','can_view')) ||
						...
						<li class="treeview <?php echo set_Topmenu('qrattendance'); ?>">
							<a href="<?php echo base_url(); ?>admin/qrattendance/setting/index"><i class="fa fa-qrcode" aria-hidden="true"></i><span><?php echo $this->lang->line('qr_code_attendance'); ?></span><i class="fa fa-angle-left pull-right"></i></a>
							<ul class="treeview-menu <?php echo set_Topmenu('qr_code_attendance'); ?>">							
									
								<?php if ($this->rbac->hasPrivilege('qr_code_attendance', 'can_view')) { ?>
								
									<li class="<?php echo set_Submenu('admin/qrattendance/attendance/index'); ?>"><a href="<?php echo base_url(); ?>admin/qrattendance/attendance/index"><i class="fas fa-angle-right"></i> <?php echo $this->lang->line('attendance'); ?> </a></li>
									
								<?php } if ($this->rbac->hasPrivilege('qr_code_setting', 'can_view')) { ?>
								
									<li class="<?php echo set_Submenu('admin/qrattendance/setting/index'); ?>"><a href="<?php echo base_url(); ?>admin/qrattendance/setting/index"><i class="fas fa-angle-right"></i> <?php echo $this->lang->line('settings'); ?></a></li>
            ...
            <?php
                ...
                if($this->module_lib->hasActive('google_authenticator')){			
                    if(($this->rbac->hasPrivilege('google_authenticate_setting','can_view')) ||
						...
						<li class="treeview <?php echo set_Topmenu('two_factor_authentication'); ?>">
							<a href="<?php echo base_url(); ?>admin/gauthenticate/admin/setup"><i class="fa fa-lock ftlayer" aria-hidden="true"></i><span><?php echo $this->lang->line('two_factor_authentication'); ?></span><i class="fa fa-angle-left pull-right"></i></a>
							<ul class="treeview-menu <?php echo set_Topmenu('two_factor_authentication'); ?>"> 
							
								<?php if ($this->rbac->hasPrivilege('google_authenticate_setup_two_fa', 'can_view')) { ?>
								
									<li class="<?php echo set_Submenu('admin/gauthenticate/admin/setup'); ?>"><a href="<?php echo base_url(); ?>admin/gauthenticate/admin/setup"><i class="fas fa-angle-right"></i> <?php echo $this->lang->line('setup_two_fa'); ?></a></li>
									
								<?php } if ($this->rbac->hasPrivilege('google_authenticate_setting', 'can_view')) { ?>
								
									<li class="<?php echo set_Submenu('admin/gauthenticate/admin'); ?>"><a href="<?php echo base_url(); ?>admin/gauthenticate/admin"><i class="fas fa-angle-right"></i> <?php echo $this->lang->line('settings'); ?> </a></li>
