               ...
               <table class="table table-bordered mb0">
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <img src="<?php echo $this->media_storage->getImageURL("./uploads/patient_id_card/barcodes/" . $id . ".png"); ?>" width="100" height="30" />
                        </a>
                        </a>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <img class="max-h-50" src="<?php echo $this->media_storage->getImageURL("./uploads/patient_id_card/qrcode/" . $id . ".png"); ?>"  width="70" height="70"  />
                        </a>
                    </td>
                  </tr>
                  <?php }  ?>                                                
            ...
            <div id="timeline_list">
               ...
               <ul class="timeline timeline-inverse">
                  ...
                  <li class="time-label">
                     <span class="bg-blue">    
                    <?php 
                    echo date($this->customlib->getHospitalDateFormat(true, true), strtotime($timeline_list[$i]['timeline_date'])); ?></span>
                  </li>
                  <li>
                     <i class="fa fa-list-alt bg-blue"></i>
                     <div class="timeline-item">
                        ...
                        <span class="time"><a class="defaults-c text-right" data-toggle="tooltip" title="" href="<?php echo base_url() . "patient/dashboard/download_patient_timeline/" . $timeline_list[$i]["id"]  ?>" data-original-title="<?php echo $this->lang->line('download'); ?>"><i class="fa fa-download"></i></a></span>
                        <?php } ?>
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="timeline-item">
                                                                <?php if (!empty($value["document"])) {?>
                                                                    <span class="time"><a class="defaults-c text-right" data-toggle="tooltip" title="" href="<?php echo base_url() . "patient/dashboard/download_patient_timeline/" . $value["id"] ?>" data-original-title="<?php echo $this->lang->line('download'); ?>"><i class="fa fa-download"></i></a></span>
                                                                <?php }?>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <th class="noExport text-right"><?php echo $this->lang->line('action'); ?></th>
                                            ...
                                            <tr class="box box-solid total-bg">
                                                <td colspan='12' class="text-right"><?php echo $this->lang->line('total') . ": " .$currency_symbol.''.number_format($total,2); ?><input type="hidden" id="charge_total" name="charge_total" value="<?php echo $total ?>">
                                                </td>
                                                <td></td>
                                            </tr>
                                             <?php }?>
                                ...
                                <div class="box-tab-header">
                                    ...
                                    <tr>
                                        ...
                                        $date = $this->customlib->YYYYMMDDTodateFormat($medication_value['date']);
                                            ?>
                                            <td class="hard_left"><?php if($subcount==1){   echo $date."<br>(".$this->lang->line(strtolower(date('l', strtotime($medication_value['date'])))).")"; }else{
