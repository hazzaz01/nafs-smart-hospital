                                ...
                                <div class="divider"></div>
                                    ...
                                    <table class="print-table">
                                        ...
                                        <tbody>
											...
											<div class="divider"></div>
                                            <tr>
                                                <td colspan="2" class="text-right"><?php echo $this->lang->line('amount'); ?></td>
                                                <td class="text-right">
                                            ...
                                            <tr>                                  
                                                <td colspan="2" class="text-right no-line"><?php echo $this->lang->line('discount');?></td>
                                                <td class="text-right no-line"><?php 
												
												$discount_amt = ($result["standard_amount"]*$result["discount_percentage"])/100;
												
												if($result["standard_amount"]>0){ echo $currency_symbol.amountFormat($discount_amt)." (".$result["discount_percentage"]." %)";}else{echo "0.00";} ?></td>
                                            </tr>                                            
                                            <tr>                                  
                                                <td colspan="2" class="text-right no-line"><?php echo $this->lang->line('tax');?></td>
                                                <td class="text-right no-line"><?php 
												
										 
												
												if($result["tax"]>0){ echo $currency_symbol.$result["tax"] ; }else{ echo $currency_symbol."0.00";} ?></td>
                                            </tr>
											<tr>
                                                <td colspan="2" class="text-right"><?php echo $this->lang->line('net_amount'); ?></td>
                                                <td class="text-right">
                                                    <?php if ($result['standard_amount'] != "") {
                                                        echo  $currency_symbol . amountFormat($result['standard_amount']-$discount_amt);
                                                    } else {
                                                        echo $currency_symbol . '0.00';
                                                    }
                                                    ?></td>
                                            ...
                                            <tr>                                  
                                                ...
                                                <td class="text-right no-line"><?php if($result["paid_amount"]>0){ echo $currency_symbol.$result["paid_amount"]; }else{ echo "0.00"; }?></td>
                                            </tr>
                                            <tr>
