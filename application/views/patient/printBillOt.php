            ...
            <div class="col-md-12">
                <div>
                    <table width="100%" class="printablea4">
                        <tr>
                            <td class="text-left rtl-text-right"><?php echo $this->lang->line('bill') . " #"; ?><?php echo $result["id"] ?>
                            </td>
                            <td class="text-right rtl-text-left"><?php echo $this->lang->line('date') . " : "; ?><?php echo date($this->customlib->getHospitalDateFormat(true, false), strtotime($result['date'])) ?>
                            </td>
                        </tr>
                    </table>
