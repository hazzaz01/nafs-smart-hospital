    ...
    <?php  if (!empty($fields)) {
       ...
       <div class="col-md-3">
        ...
        <tr>         
		  ...
		  if (!empty($result->tax)) {
            echo $currency_symbol.$result->tax.' ('.amountFormat($tax_percentage).'%)' ;
          }  ?></td>
        </tr>
        <tr>   
     ...
     <?php
                      $row_counter=1;
                        ...
                        <tr>
                                ...
                                <td class="text-right"><?php echo $currency_symbol.number_format(($tax_amount),2)." (".$report_value->tax_percentage."%)"; ?></td>
                                 <td class="text-right"><?php echo $currency_symbol.amountFormat($report_value->apply_charge - $discount_amt + $tax_amount); ?></td>
