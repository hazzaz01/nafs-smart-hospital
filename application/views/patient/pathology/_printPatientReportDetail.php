                                        ...
                                        foreach ($result->pathology_parameter as $parameter_key => $parameter_value) {
                                            ...
                                            <tr class="<?php echo "$row_cls"; ?>">
                                                ...
                                                <td class="text-left"><?php                                                 
                                                  echo  ($range_patient)? "<span class='text-danger'>".$parameter_value->pathology_report_value." ".$parameter_value->unit_name."</span>":(($parameter_value->pathology_report_value == "") ? "" :"<span>".$parameter_value->pathology_report_value." ".$parameter_value->unit_name."</span>");                 
                                                ?>
                                                </td>
                                            </tr>
                                        <?php
