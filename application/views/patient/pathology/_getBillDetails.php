                ...
                <div class="card-body">  
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p><span class="font-bold"><?php echo $this->lang->line('gender'); ?> :</span> <?php echo $this->lang->line(strtolower($result->gender)); ?></p>
                            <?php  if (!empty($fields)) {
                    ...
                    $row_counter++;
                        ...
                        ?>  
                                ...
                                <tr>
                                   ...
                                   <td class="text-right no-line"><?php echo $currency_symbol . "" . amountFormat($result->tax).' ('.$report_value->tax_percentage.'%)'; ?></td>
                                </tr>
                                <tr>
                                   <td colspan="3" class="no-line"></td>
                                  ...
                                  <tr>
                                   ...
                                   <td class="text-right no-line"><?php echo $currency_symbol . "" . amountFormat(($amount-$result->discount)+$result->tax-$result->total_deposit); ?></td>
                                </tr>
                             </tbody>
                          </table>
                        </div>
