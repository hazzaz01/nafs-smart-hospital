      ...
      <div class="row">
                <?php if ($this->module_lib->hasPatientActive('opd')) { ?>
                    <div class="col-lg-2 col-md-3 col-sm-6 col20">
                        <div class="info-box" title="<?php echo $this->lang->line('opd'); ?>">
                ...
                <?php  if ($this->module_lib->hasPatientActive('ipd')) { ?>
                    <div class="col-lg-2 col-md-3 col-sm-6 col20" title="<?php echo $this->lang->line('ipd'); ?>">
                        <div class="info-box">
                ...
                <?php if ($this->module_lib->hasPatientActive('pharmacy')) { ?>
                     <div class="col-lg-2 col-md-3 col-sm-6 col20" title="<?php echo $this->lang->line('pharmacy'); ?>">
                        <div class="info-box">
                ...
                <?php if ($this->module_lib->hasPatientActive('pathology')) { ?>
                    <div class="col-lg-2 col-md-3 col-sm-6 col20" title="<?php echo $this->lang->line('pathology'); ?>">
                        <div class="info-box">
                ...
                <?php if ($this->module_lib->hasPatientActive('radiology')) { ?>
                   <div class="col-lg-2 col-md-3 col-sm-6 col20" title="<?php echo $this->lang->line('radiology'); ?>">
                        <div class="info-box">
                ...
                <?php if ($this->module_lib->hasPatientActive('blood_bank')) { ?>
                    <div class="col-lg-2 col-md-3 col-sm-6 col20" title="<?php echo $this->lang->line('blood_bank'); ?>">
                        <div class="info-box">
                ...
                <?php if ($this->module_lib->hasPatientActive('ambulance')) { ?>
                    <div class="col-lg-2 col-md-3 col-sm-6 col20" title="<?php echo $this->lang->line('ambulance'); ?>">
                        <div class="info-box">
