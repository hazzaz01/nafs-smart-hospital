                            ...
                            <form action="<?php echo base_url(); ?>patient/onlineappointment/walkingm/pay" method="post">
                                    <table class="table2" width="100%">
                                        ...
                                        <tr class="border_bottom">
                                            ...
                                            <td class="text-right text-rtl-left"><input value="<?php echo set_value('email'); ?>" class="form-control" type="text" name="email"></td>
                                        </tr>
                                        <tr class="border_bottom">
                                            <td> 
                                                <span class=""><?php echo $this->lang->line('walkingm_password'); ?></span></td>
                                            <td class="text-right text-rtl-left"><input value="<?php echo set_value('password'); ?>" type="password" class="form-control" name="password"></td>
                                        </tr>
                                        <?php 
                                            if(isset($api_error)){
                                        ...
                                        ?>
                                         <tr class="bordertoplightgray">
                                            ...
                                            <td  bgcolor="#fff" class="text-right text-rtl-left"><button type="submit"  name="search"  value="" class="btn btn-info"><?php echo $this->lang->line("pay_with_walkingm"); ?> <i class="fa fa-chevron-right chevron-rtl-right"></i></button></td>
                                        </tr>
                                    </table>
