                            ...
                            <form id="payuForm" action="<?php echo $action; ?>" method="post">
                                    ...
                                    <tr class="bordertoplightgray">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td  bgcolor="#fff" class="text-right text-rtl-left"><button type="submit"  name="search"  value="" class="btn btn-info submit_button"><?php echo $this->lang->line("pay_with_payu"); ?> <i class="fa fa-chevron-right chevron-rtl-right"></i></button>  </td>
                                        </tr>
                                    </table>
