                            ...
                            <form action="<?php echo base_url(); ?>patient/onlineappointment/onepay" method="post">
                                    <table class="table2" width="100%">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td  bgcolor="#fff" class="text-right text-rtl-left"><button type="submit"  name="search"  value="" class="btn btn-info"><?php echo $this->lang->line("pay_with_onepay"); ?> <i class="fa fa-chevron-right chevron-rtl-right"></i></button></td>
                                        </tr>
                                    </table>
