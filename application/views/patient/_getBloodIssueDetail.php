    ...
    <div class="col-md-8">
      <table class="table table-striped table-hover">
        ...
        <tr>
          ...
          <td width="60%"><?php echo $this->customlib->bag_string($result['bag_no'],$result['volume'],$result['unit_name'])?></td> 
        </tr>
        <tr>
    ...
    <div class="col-md-4">
      <table class="table table-striped table-hover">
        ...
        <tr>    
          ...
          <td width="60%" class="text text-right"><?php echo $currency_symbol.calculatePercent($result['amount'],$result['discount_percentage'])?><?php echo " (".$result['discount_percentage']."%) "; ?></td>
        </tr>        
        <tr>
          ...
          <td width="60%" class="text text-right"><?php echo $currency_symbol.calculatePercent($total_tax_amount,$result['tax_percentage'])?><?php echo " (".$result['tax_percentage']."%) "; ?></td>
        </tr>
        <tr>        
