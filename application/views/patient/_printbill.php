                    ...
                    <div class="row">
                     ...
                     <table class="noborder_table mb-0">
                        ...
                        <tr>
                            ...
                            <td><?php echo $this->lang->line(strtolower($result["department_name"])); ?></td>
                        </tr>						 
                    </table>
                </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <table class="print-table">
                             ...
                             <tbody>
                                ...
                                <tr>                          
                                   <td colspan="3" class="text-right "><?php echo $this->lang->line('amount');?></td>
								...
								<tr>                          
								   ...
								   echo $currency_symbol.amountFormat($discount_amt).' ('.$charge->discount_percentage.'%)'; ?></td>
                                </tr>
                                <tr>                                   
                                   <td colspan="3" class="text-right no-line"><?php echo $this->lang->line('tax');?></td>
                                   <td class="text-right no-line"><?php 
                                   if($charge->tax>0){
                                     $tax_amt = (($charge->apply_charge-$discount_amt)*$charge->tax/100);
                                   }else{
                                      $tax_amt = 0;
                                   }                                  
                                ...
                                <tr>
                                   ...
                                   <td class="text-right no-line"><?php 
                                   echo $currency_symbol.amountFormat($charge->apply_charge+$tax_amt-$discount_amt); ?></td>
                                </tr>
                                   <tr>                                  
                                ...
                                $amount_paid=(!isset($transaction) || empty($transaction)) ? 0:  $transaction->amount;
                                   ...
                                   <td class="text-right no-line"><?php 
                                $amount_paid=(!isset($transaction) || empty($transaction)) ? 0:  $transaction->amount;
                                   echo $currency_symbol.amountFormat(($charge->apply_charge+$tax_amt-$discount_amt)-$amount_paid); ?></td>
                                </tr>
                             </tbody>
                          </table>
                        </div>
