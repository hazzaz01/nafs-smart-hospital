        ...
        <div class="table-responsive">
            <table class="table mb0 table-striped table-bordered examples tablelr0space noborder">
                ...
                <tr>
                    ...
                    <td width="35%"><span id='gen'><?php if(!empty($result['gender'])){ echo $this->lang->line(strtolower($result['gender'])); } ?></span></td>
                </tr>
                <tr>
                    <th width="15%"><?php echo $this->lang->line('marital_status'); ?></th>
                    <td width="35%"><span id="marital_status"><?php if(!empty($result['marital_status'])){ echo $this->lang->line(strtolower($result['marital_status'])); } ?></span></td>
                ...
                <tr>  
                    ...
                    <td width="35%"><span id="age"><?php if(!empty($result['day'])){ echo $this->customlib->get_patient_current_age($result['patient_id']); } ?></span></td>
