...
if ($content_value->file_type == 'xls' || $content_value->file_type == 'xlsx') {
                ?>
     <img src="<?php echo $this->media_storage->getImageURL('backend/images/excelicon.png'); ?>">
<?php
} elseif ($content_value->file_type == 'ppt' || $content_value->file_type == 'pptx') {
                ?>
     <img src="<?php echo $this->media_storage->getImageURL('backend/images/pptxicon.png'); ?>">
<?php
} elseif ($content_value->file_type == 'doc' || $content_value->file_type == 'docx') {
                ?>
     <img src="<?php echo $this->media_storage->getImageURL('backend/images/wordicon.png'); ?>">
<?php
} elseif ($content_value->file_type == "csv") {
                ?>
     <img src="<?php echo $this->media_storage->getImageURL('backend/images/txticon.png'); ?>">
<?php
} elseif ($content_value->file_type == "pdf") {
                ?>
     <img src="<?php echo $this->media_storage->getImageURL('backend/images/pdficon.png'); ?>">
<?php
...
<?php
                ...
                ?>
     <img src="<?php echo $this->media_storage->getImageURL('backend/images/zipicon.png'); ?>">
<?php
...
<?php
                ...
                ?>
   <img src="<?php echo $this->media_storage->getImageURL('backend/images/video-icon.png'); ?>">
<?php
} else {
                ?>
     <img src="<?php echo $this->media_storage->getImageURL('backend/images/docsicon.png'); ?>">
<?php
}
      ...
      <?php
          ...
          <a href="<?php echo site_url('site/download_content/' . $content_value->upload_content_id . "/" . $this->enc_lib->encrypt($content_value->share_content_id)) ?>"
            ...
            >
             ...
             <?php echo ($content_value->file_type == "video") ? $content_value->vid_title : ($content_value->real_name); ?> <i class="fa fa-download"  data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('download'); ?>" ></i> </a>
         </li>
