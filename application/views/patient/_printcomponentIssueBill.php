                ...
                <div class="card-body">  
                    <div class="row"> 
                        ...
                        <div class="col-md-6">                            
                            ...
                            <p><?php echo $this->lang->line('bag'); ?> : <?php echo $this->customlib->bag_string($blood_issues_detail['bag_no'],$blood_issues_detail['volume'],$blood_issues_detail['unit_name']); ?></p>
                            <p>
                                <?php
                                    if (!empty($fields)) {
                             ...
                             <tbody>
								...
								<tr>
                                   ...
                                   <td><?php echo $blood_issues_detail['charge_categorie_name'];?><br>
                                    ...
                                    <td class="text-center"><?php echo $tax_amt;?><br>
                                    </td>                                 
                                ...
                                <tr>
                                   ...
                                   <td class="text-right no-line"><?php echo $currency_symbol . "" . $blood_issues_detail['amount']+$tax_amt-$discont_amt; ?></td>
                                </tr>							
                                <tr>
                                   <td colspan="2" class="no-line"></td>
