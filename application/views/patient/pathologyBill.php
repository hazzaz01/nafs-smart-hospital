                                    ...
                                    foreach ($result as $detail) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $detail->note; ?></td>
                                                ...
                                                ?>   
                                            <td class="text-right"><?php echo number_format((float)$detail->total, 2, '.', ''); ?></td>

                                            <td class="text-right"><?php echo number_format((float)$detail->discount, 2, '.', ''); ?> (<?php echo number_format((float)$detail->discount_percentage, 2, '.', ''); ?>%) </td>
											
                                            <td class="text-right"><?php 
											$tax_percentage	=	($detail->tax*100)/($detail->total - $detail->discount);
											echo number_format((float)$detail->tax, 2, '.', ''); ?> (<?php echo number_format((float)$tax_percentage, 2, '.', '');  ?>%)</td>
