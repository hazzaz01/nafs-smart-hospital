      ...
      <div class="col-md-3">
        <table class="table table-hover table-sm">        
          ...
          <tr> 
            ...
            <td class="text text-right"><?php echo $currency_symbol.$result->discount .' ('.$result->discount_percentage.'%)' ;?></td>
          </tr>
          <tr>                
            <th><label><?php echo $this->lang->line('tax'); ?></label></th>
            <td class="text text-right"><?php 
			$tax_percentage = ($result->tax*100)/($result->total-$result->discount);
			echo $currency_symbol.$result->tax.' ('.amountFormat($tax_percentage).'%)' ?></td>
          </tr>
          <tr>               
    	  ...
    	  <table class="table table-hover table-sm">
            <thead>
              <tr class="line">
                ...
                <td class="text-right"><?php echo $this->lang->line('net_amount'); ?></td>
            ...
            ?>
              <tr>
                ...
                <td class="text-right"><?php echo $currency_symbol.number_format(($taxamount),2)." (".$report_value->tax_percentage."%)"; ?></td>
                <td class="text-right"><?php echo $currency_symbol.amountFormat($report_value->apply_charge - $discount_amt + $taxamount); ?></td>
                <td class="text-right">
                    ...
                    ?>
                  <a href="<?php echo site_url('patient/dashboard/downloadRadiologyReport/'.$report_value->id) ?>"  data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('download'); ?>"  class='btn btn-default btn-xs'><i class="fa fa-download"></i></a>
                  <?php
                  }
                  ?>
                </td>    
