        ...
        <div class="row">
            <div class="col-md-7">
                <div class="row">
                    <div class="doctor-box ptt10">
                        <img class="col-md-4" id="staff_image" src="<?php echo $this->media_storage->getImageURL("uploads/staff_images/no_image.png") ?>">
                        <div class="col-md-8">
            ...
            <div class="col-md-5 bg__lightgray">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                    <div class="form-group"> 
                         <!-- input for credentialstatus -->
                        <input type="hidden" value="0" id="credential_status" name="credential_status">
                         <!-- input for credentialstatus -->
...
<script>
    ...
    $(document).ready(function () {
     ...
     function updatePatientID(patient_type) {
		 $("#verify_code").removeClass('show');
         $("#verify_code").addClass('hide');
         $("#submitbtn").text('<?php echo $this->lang->line('submit'); ?>');
    ...
    $("#appointment_form").submit(function(){
        ...
        $.ajax({
            ...
            success: function (data){
                console.log(data);
                if(data.status==2){
                    //status = 2  means user id and password is correct
                    // show the google authentication
                    $("#credential_status").val(1);
                    $("#login_form").addClass('hide');
                    $("#verify_code").removeClass('hide');
                    $("#verify_code").addClass('show');
                    $("#submitbtn").text('<?php echo $this->lang->line('verify_login'); ?>');
                }
                ...
                var credential_status=$("#credential_status").val(); 
                if(credential_status==1){                  
                    $("#submitbtn").text('<?php echo $this->lang->line('verify_login'); ?>');
                }else if(credential_status==0){
                    $("#submitbtn").text('<?php echo $this->lang->line('submit'); ?>');
                }               
            },
