                                    ...
                                    <ul id="" class="" >
                                        ...
                                        if (!empty($banner_notices)) {
                                            foreach ($banner_notices as $banner_notice_key => $banner_notice_value) {
                                                if(isset($banner_notice_value['date'])){
                                                ?>
                                                <li><a href="<?php echo site_url('read/' . $banner_notice_value['slug']) ?>"><div class="datenews"><?php echo date('d', strtotime($banner_notice_value['date'])); ?> <span><?php echo $this->lang->line(strtolower(date('F', strtotime($banner_notice_value['date'])))); ?></span></div><?php echo $banner_notice_value['title']; ?>
                                                    </a></li>
                                                <?php
                                                }
                                            }
                ...
                <div class="col-md-12">
                    <nav class="navbar">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand logo" href="<?php echo base_url(); ?>"><img src="<?php echo $this->media_storage->getImageURL($front_setting->logo) ?>" alt=""/></a>
                        </div>
