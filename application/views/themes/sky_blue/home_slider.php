                    ...
                    <div class="carousel-inner">
                        ...
                        foreach ($banner_images as $banner_img_key => $banner_img_value) {
                            ...
                            <div class="item <?php if ($banner_first) echo 'active'; ?>">
                                <img src="<?php echo $this->media_storage->getImageURL($banner_img_value->dir_path . $banner_img_value->img_name) ?>" alt="" />
                            </div>
                            <?php
                            $banner_first = FALSE;
                        }
                                        ...
                                        foreach ($banner_notices as $banner_notice_key => $banner_notice_value) {
                                            ...
                                            <li>
                                                <a href="<?php echo site_url('read/' . $banner_notice_value['slug']) ?>">
                                                    <div class="datenews">
                                                    <?php    if(isset($banner_notice_value['date'])){ ?>
                                                        <?php echo date('d', strtotime($banner_notice_value['date'])); ?>
                                                        <span><?php echo $this->lang->line(strtolower(date('F', strtotime($banner_notice_value['date'])))); ?></span>
                                                    <?php } ?>
                                                    </div>
