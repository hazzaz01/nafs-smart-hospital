                                        ...
                                        <div class="form-group row">
                                         ...
                                         <?php
                                            if ($settinglist->image == "") {
                                                ?>
                                                <img src="<?php echo $this->media_storage->getImageURL('uploads/hospital_content/logo/images.png') ?>" class="" alt="" style="height: 15px;">
                                                <?php
                                            } else {
                                                ?>
                                                <img src="<?php echo $this->media_storage->getImageURL('uploads/hospital_content/logo/'.$settinglist->image) ?>" class="" alt="" style="height: 15px;margin-top: 5px;">
                                                <?php
                                            }
                                            ?>&nbsp;
                                    ...
                                    <div class="col-md-6">
                                         <div class="form-group row">
                                            ...
                                            if ($settinglist->mini_logo == "") {
                                                ?>
                                                <img style="height: 15px;margin-top: 5px;" src="<?php echo $this->media_storage->getImageURL('uploads/hospital_content/logo/images.png') ?>" class="" alt="">
                                                <?php
                                            } else {
                                                ?>
                                                <img style="height: 15px;margin-top: 5px;" src="<?php echo $this->media_storage->getImageURL('uploads/hospital_content/logo/'.$settinglist->mini_logo) ?>" class="" alt="">
                                                <?php
                                            }
                                            ?>
                                             &nbsp; <?php if ($this->rbac->hasPrivilege('general_setting', 'can_edit')) { ?>
                                        ...
                                        <div class="form-group row">
                                             ...
                                             <?php
						                        if ($settinglist->app_logo == "") {
						                            ?>
						                            <img src="<?php echo $this->media_storage->getImageURL('uploads/hospital_content/logo/images.png') ?>" alt="" style="height: 15px;">
						                            <?php
						                        } else {
						                            ?>
						                            <img src="<?php echo $this->media_storage->getImageURL('uploads/hospital_content/logo/'.$settinglist->app_logo) ?>" alt="" style="height: 15px;margin-top: 5px;">
						                            <?php
						                        }
						                        ?>
                                                <?php if ($this->rbac->hasPrivilege('general_setting', 'can_edit')) { ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="base_url" name="base_url" value="<?php echo $settinglist->base_url; ?>">
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       <div class="col-sm-8">
                                                <input type="text" class="form-control"  id="folder_path" name="folder_path" value="<?php echo $settinglist->folder_path; ?>">
