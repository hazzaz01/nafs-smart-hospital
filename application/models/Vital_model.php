...
class Vital_model extends MY_Model
{
    ...
    public function add($data)
    {
        ...
        if (isset($data['id']) && $data['id'] != null) {
            ...
            $message = UPDATE_RECORD_CONSTANT . " On Vitals id " . $data['id'];
            $action = "Update";
            $record_id = $data['id'];
            ...
            $message = INSERT_RECORD_CONSTANT . " On Vitals id " . $insert_id;
            $action = "Insert";
            $record_id = $insert_id;
            $this->log($message, $record_id, $action);
        }
    ...
    public function addpatientvital($data)
    {
        ...
        if (isset($data['id']) && $data['id'] != null) {
            ...
            $message = UPDATE_RECORD_CONSTANT . " On Patients Vitals id " . $data['id'];
            $action = "Update";
            $record_id = $data['id'];
            $this->log($message, $record_id, $action);
        } else {
            ...
            $message = INSERT_RECORD_CONSTANT . " On Patients Vitals id " . $insert_id;
            $action = "Insert";
            $record_id = $insert_id;
            $this->log($message, $record_id, $action);       
        }
    ...
    public function delete_patient_vital($id)
    {
        ...
        $message   = DELETE_RECORD_CONSTANT . " On Patients Vitals id " . $id;
        $action    = "Delete";
        $record_id = $id;
        $this->log($message, $record_id, $action);
    }    
