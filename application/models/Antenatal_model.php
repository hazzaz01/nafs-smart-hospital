...
class Antenatal_model extends MY_Model
{
    public function add_obstetrichistory($insert_history, $update_history)
    {
        ...
        if (!empty($insert_history)) {
            ...
            $message = INSERT_RECORD_CONSTANT . " On Obstetric History id " . $insert_id;
            $action = "Insert";
            $record_id = $insert_id;
        ...
        if (!empty($update_history)) {
            ...
            $message = UPDATE_RECORD_CONSTANT . " On Obstetric History id " . $id ;
            $action = "Update";
            $record_id = $id ;
            $this->log($message, $record_id, $action);
        }
    ...
    public function addantenatalexamine($data){
		...
		if($data['id']!=""){
			...
			$message = UPDATE_RECORD_CONSTANT . " On Postnatal Examine id " . $id;
            $action = "Update";
            $record_id = $id;
            $this->log($message, $record_id, $action);
		}else{
            ...
            $insert_id = $this->db->insert_id();
            $message = INSERT_RECORD_CONSTANT . " On Postnatal Examine id " . $insert_id;
            $action = "Insert";
            $record_id = $insert_id;
            $this->log($message, $record_id, $action);
        }
    ...
    {
        $custom_fields = $this->customfield_model->get_custom_fields('antenatal',1);
        $custom_field_column_array = array();
        $field_var_array = array();
        $i=1;
        if (!empty($custom_fields)) {
            foreach ($custom_fields as $custom_fields_key => $custom_fields_value) {
                ...
                array_push($custom_field_column_array, 'table_custom_' . $i . '.field_value');
                array_push($field_var_array, '`table_custom_' . $i . '`.`field_value` as `' . $custom_fields_value->name.'`');
                $this->db->join('custom_field_values as '.$tb_counter,'primary_examine.id = '.$tb_counter.'.belong_table_id AND '.$tb_counter.'.custom_field_id = '.$custom_fields_value->id,"left");
                $i++;
            }
        }
    ...
    public function deleteobstetrichistory($id){
		...
		$message   = DELETE_RECORD_CONSTANT . " On Obstetric History id " . $id;
        $action    = "Delete";
        $record_id = $id;
        $this->log($message, $record_id, $action);
        //======================Code End==============================
    ...
    public function addpostnatal($data){
       ...
       if(isset($data['id']) && $data['id']!=""){
            ...
            $message = UPDATE_RECORD_CONSTANT . " On Postnatal Examine id " . $data['id'];
            $action = "Update";
            $record_id = $data['id'];
            $this->log($message, $record_id, $action);
       }else{
    ...
    public function getpostnatalbyid($id){
     ...
     public function deletepostnatal($id){
		...
		$message   = DELETE_RECORD_CONSTANT . " On Postnatal Examine id " . $id;
        $action    = "Delete";
        $record_id = $id;
        $this->log($message, $record_id, $action);
        //======================Code End==============================
    ...
    public function deleteantenatal($id){
        ...
        $message   = DELETE_RECORD_CONSTANT . " On Primary Examine id " . $id;
        $action    = "Delete";
        $record_id = $id;
        $this->log($message, $record_id, $action);
        ...
        $message   = DELETE_RECORD_CONSTANT . " On Antenatal Examine id " . $id;
        $action    = "Delete";
        $record_id = $id;
        $this->log($message, $record_id, $action);
    ...
    public function addipdantenatalprescription($data){
        ...
        if($data['id']!=""){            
            ...
            $this->db->where('id',$id);
            $this->db->update('primary_examine',$data);
            $message = UPDATE_RECORD_CONSTANT . " On Primary Examine id " . $id;
            $action = "Update";
            $record_id = $id;
            $this->log($message, $record_id, $action);
        }else{
            ...
            $this->db->insert('primary_examine',$data);
            $insert_id = $this->db->insert_id();
            $message = INSERT_RECORD_CONSTANT . " On Primary Examine id " . $insert_id;
            $action = "Insert";
            $record_id = $insert_id;
            $this->log($message, $record_id, $action);
        }  
    ...
    public function addipdantenatalexamine($data){
        ...
        if($data['id']!=""){
            ...
            $this->db->where('id',$id);
            $this->db->update('antenatal_examine',$data);
            $message = UPDATE_RECORD_CONSTANT . " On Antenatal Examine id " . $id;
            $action = "Update";
            $record_id = $id;
            $this->log($message, $record_id, $action);
        }else{
            ...
            $this->db->insert('antenatal_examine',$data);
            $insert_id = $this->db->insert_id();
            $message = INSERT_RECORD_CONSTANT . " On Antenatal Examine id " . $insert_id;
            $action = "Insert";
            $record_id = $insert_id;
            $this->log($message, $record_id, $action);
        }
