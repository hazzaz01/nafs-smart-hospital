...
class Income_model extends MY_Model
{
    ...
    public function getAllRecord()
    {
        ...
        $this->datatables
            ->select('income.id,income.date,income.name,income.invoice_no,income.amount,income.documents,income.note,income_head.income_category,income.inc_head_id,generated_by_staff.name as generated_byname,generated_by_staff.surname as generated_bysurname,generated_by_staff.employee_id as generated_byemployee_id' . $field_variable)           
            ->searchable('income.name,income.invoice_no,income.date,income.note,income_head.income_category'.$custom_field_column)
            ->orderable('income.name,income.invoice_no,income.date,income.note,income_head.income_category'.$custom_field_column.',income.amount')
            ->join('income_head', 'income.inc_head_id = income_head.id')
            ->join('staff as generated_by_staff', 'generated_by_staff.id = income.generated_by', "left")
            ->sort('income.id', 'desc') 
            ->from('income');
