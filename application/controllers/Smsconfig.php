...
class Smsconfig extends Admin_Controller
{
    ...
    public function clickatell()
    {
        ...
        $this->form_validation->set_rules('clickatell_api_id', $this->lang->line('clickatell_api_key'), 'required');
    ...
    public function nexmo()
    {
        ...
        $this->form_validation->set_rules('nexmo_registered_phone_number', $this->lang->line('registered_from_number'), 'required');
