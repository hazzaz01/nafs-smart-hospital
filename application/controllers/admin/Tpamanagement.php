...
class Tpamanagement extends Admin_Controller
{
    ...
    public function add_oragnisation()
    {
        ...
        $this->form_validation->set_rules('contact_number', $this->lang->line('contact_no'), 'required|numeric');
    ...
    public function edit()
    {
        ...
        $this->form_validation->set_rules('econtact_number', $this->lang->line('contact_number'), 'required|numeric');
        if ($this->form_validation->run() == false) {
            $msg = array(
                'e1' => form_error('ename'),
                'e2' => form_error('ecode'),
