        ...
        if (!empty($reportdata->data)) {
            foreach ($reportdata->data as $key => $value) {
                ...
                if ($value->opd_details_id) {
					...
					$patient = $this->patient_model->getDetails($value->opd_details_id);
					$patient_name = $patient['patient_name'].' ('.$patient['pid'].')';				
                ...
                if ($value->ipd_details_id) {
					...
					$patient = $this->patient_model->getIpdDetails($value->ipd_details_id);
					$patient_name = $patient['patient_name'].' ('.$patient['id'].')';	
